...
<div id="modal-content" class="modal-content hide">
	<ul class="share clearfix">
		...
		<li class="share-button">
			<a href="http://b.hatena.ne.jp/entry/" class="hatena-bookmark-button" data-hatena-bookmark-layout="simple" data-hatena-bookmark-width="100" data-hatena-bookmark-height="100" title="このエントリーをはてなブックマークに追加"><img src="<?php echo get_template_directory_uri(); ?>/img/hatenabookmark-logomark.svg" alt="このエントリーをはてなブックマークに追加" width="100" height="100" style="border: none;" /></a><script type="text/javascript" src="https://b.st-hatena.com/js/bookmark_button.js" charset="utf-8" async="async"></script>
		</li>
	</ul>
</div>
