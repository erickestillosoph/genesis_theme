...
?>
<div class="share-<?php echo esc_attr( $options['sns_share_design_type'] ); ?> share-top">
<?php
// Type5
...
?>
			<li class="default twitter_button">
				<a href="https://twitter.com/share" <?php if($options['twitter_info']){ echo 'data-via="' . esc_html($options['twitter_info']) . '"'; }; ?> class="twitter-share-button">Tweet</a>
			</li>
<?php 
		endif; 
		if ( $options['show_sns_share_fblike'] ) : 
?>
...
<?php 
		...
		if ( $options['show_sns_share_fbshare'] ) : 
?>
...
?>
<?php 
		if ( $options['show_sns_share_feedly'] ) : 
?>
			<li class="default feedly_button">
				<a href='//feedly.com/index.html#subscription/feed/<?php bloginfo('rss2_url'); ?>'<?php echo ( is_mobile() ) ? '' : ' target="_blank"'; ?>><img id='feedlyFollow' src='//s3.feedly.com/img/follows/feedly-follow-rectangle-flat-small_2x.png' alt='follow us in feedly' width='66' height='20'></a>
			</li>
<?php 
		endif; 
...
?>
	<div class="sns">
		<ul class="<?php echo esc_attr( $options['sns_share_design_type'] ); ?> clearfix">
<?php 
		if ( $options['show_sns_share_twitter'] ) : 
?>
			<li class="twitter">
				<a href="//twitter.com/share?text=<?php echo $title_encode ?>&url=<?php echo $url_encode ?>&via=<?php echo $options['twitter_info']; ?>&tw_p=tweetbutton&related=<?php echo $options['twitter_info']; ?>"><i class="icon-twitter"></i><span class="ttl">Tweet</span><span class="share-count"><?php if(function_exists('scc_get_share_twitter')) echo (scc_get_share_twitter()==0)?'':scc_get_share_twitter(); ?></span></a>
			</li>
<?php 
		endif; 
		if ( $options['show_sns_share_fbshare'] ) : 
...
?>
			<li class="feedly">
				<a href="//feedly.com/index.html#subscription/feed/<?php bloginfo('rss2_url'); ?>"><i class="icon-feedly"></i><span class="ttl">feedly</span><span class="share-count"><?php if(function_exists('scc_get_follow_feedly')) echo (scc_get_follow_feedly()==0)?'':scc_get_follow_feedly(); ?></span></a>
			</li>
<?php 
		endif; 
		if ( $options['show_sns_share_pinterest'] ) : 
...
?>
			<li class="twitter">
				<a href="//twitter.com/share?text=<?php echo $title_encode ?>&url=<?php echo $url_encode ?>&via=<?php echo $options['twitter_info']; ?>&tw_p=tweetbutton&related=<?php echo $options['twitter_info']; ?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=400,width=600');return false;"><i class="icon-twitter"></i><span class="ttl">Tweet</span><span class="share-count"><?php if(function_exists('scc_get_share_twitter')) echo (scc_get_share_twitter()==0)?'':scc_get_share_twitter(); ?></span></a>
			</li>
<?php 
		endif; 
		if ( $options['show_sns_share_fbshare'] ) : 
...
?>
			<li class="pocket">
				<a href="//getpocket.com/edit?url=<?php echo $url_encode;?>&title=<?php echo $title_encode;?>" target="blank"><i class="icon-pocket"></i><span class="ttl">Pocket</span><span class="share-count"><?php if(function_exists('scc_get_share_pocket')) echo (scc_get_share_pocket()==0)?'':scc_get_share_pocket(); ?></span></a>
			</li>
<?php 
		endif; 
		if ( $options['show_sns_share_rss'] ) : 
...
?>
			<li class="feedly">
				<a href="//feedly.com/index.html#subscription/feed/<?php bloginfo('rss2_url'); ?>" target="blank"><i class="icon-feedly"></i><span class="ttl">feedly</span><span class="share-count"><?php if(function_exists('scc_get_follow_feedly')) echo (scc_get_follow_feedly()==0)?'':scc_get_follow_feedly(); ?></span></a>
			</li>
<?php 
		endif; 
		if ( $options['show_sns_share_pinterest'] ) : 
