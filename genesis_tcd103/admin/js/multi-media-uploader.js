  ...
  custom_uploader[buttonId].on('select', function () { 
    ...
    attachments.each(function (attachment) {
      ...
      if (attachment.attributes.type == 'image') {
        $(button).siblings('ul').append('<li data-attechment-id="' + attachment['id'] + '"><img class="true_pre_image" src="' + attachment.attributes.sizes.thumbnail.url + '" /><span class="delete-img"></span></li>');
      } else {
        $(button).siblings('ul').append('<li data-attechment-id="' + attachment['id'] + '"><img class="true_pre_image" src="' + attachment.attributes.icon + '" /><span class="delete-img"></span></li>');
      }
      i++;
