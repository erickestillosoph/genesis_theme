jQuery(document).ready(function ($) {
  // サービス詳細ページ
  $(document).on("click", "#service_link_list_layout_type1", function (event) {
    if ($(this).prop("checked")) {
      $(".service_link_list_layout_type1_option").show();
      $(".service_link_list_layout_type2_option").hide();
    }
  });
  $(document).on("click", "#service_link_list_layout_type2", function (event) {
    if ($(this).prop("checked")) {
      $(".service_link_list_layout_type1_option").hide();
      $(".service_link_list_layout_type2_option").show();
    }
  });
  if ($("#service_link_list_layout_type1").prop("checked")) {
    $(".service_link_list_layout_type1_option").show();
    $(".service_link_list_layout_type2_option").hide();
  }
  if ($("#service_link_list_layout_type2").prop("checked")) {
    $(".service_link_list_layout_type1_option").hide();
    $(".service_link_list_layout_type2_option").show();
  }
  ...
  $(document).on(
    "click",
    "#index_slider_layout1, #index_slider_layout2",
    function (event) {
      if ($(this).prop("checked")) {
        $(".header_slider_layout1_option").show();
        $(".header_slider_layout3_option").hide();
      }
    }
  );
  $(document).on("click", "#index_slider_layout3", function (event) {
    if ($(this).prop("checked")) {
      $(".header_slider_layout1_option").hide();
      $(".header_slider_layout3_option").show();
    }
  });
  if ($("#index_slider_layout1").prop("checked")) {
    $(".header_slider_layout1_option").show();
    $(".header_slider_layout3_option").hide();
  }
  if ($("#index_slider_layout2").prop("checked")) {
    $(".header_slider_layout1_option").show();
    $(".header_slider_layout3_option").hide();
  }
  if ($("#index_slider_layout3").prop("checked")) {
    $(".header_slider_layout1_option").hide();
    $(".header_slider_layout3_option").show();
  }
  ...
  $(document).on("change", ".footer_bar_icon_type input", function (event) {
    ...
    if (radioval == "material_icon") {
      $(this)
        .closest(".footer_bar_icon_option")
        .find(".material_icon_option")
        .show();
    } else {
      $(this)
        .closest(".footer_bar_icon_option")
  ...
  $(document).on(
    "click",
    "#loading_type1, #loading_type2, #loading_type3",
    function (event) {
      if ($(this).prop("checked")) {
  ...
  // 固定ページのヘッダー
  $(document).on("click", "#header_type_type1", function (event) {
    if ($(this).prop("checked")) {
      $(".header_type1_option").show();
    }
  });
  $(document).on("click", "#header_type_type2", function (event) {
    if ($(this).prop("checked")) {
      $(".header_type1_option").hide();
    }
  });
  if ($("#header_type_type1").prop("checked")) {
    $(".header_type1_option").show();
  }
  if ($("#header_type_type2").prop("checked")) {
    $(".header_type1_option").hide();
  }

  // カスタムナビゲーションの画像フィールドとサブタイトルの表示
  $(document).on("click", "#locations-drawer-menu", function (event) {
    if ($(this).is(":checked")) {
      $(".custom_nav_image_field").show();
      $(".custom_nav_subtitle_field").show();
    } else {
      $(".custom_nav_image_field").hide();
      $(".custom_nav_subtitle_field").hide();
    }
  });
  if ($("#locations-drawer-menu").is(":checked")) {
    $(".custom_nav_image_field").show();
    $(".custom_nav_subtitle_field").show();
  } else {
    $(".custom_nav_image_field").hide();
  ...
  $(document).on("click", ".sub_box_tab .tab", function (event) {
    ...
    $(this)
      .closest(".tab_parent")
      .find(".sub_box_tab_content")
      .each(function () {
        $(this).removeClass("active");
      });
    $(this)
      .closest(".tab_parent")
      .find('[data-tab-content="' + tab_name + '"]')
      .each(function () {
        $(this).addClass("active");
      });
  ...
  $(document).on(
    "change keyup",
    ".sub_box_tab_content .tab_label",
    function () {
      var tab_content_name = $(this)
        .closest(".sub_box_tab_content")
        .attr("data-tab-content");
      $(this)
        .closest(".tab_parent")
        .find('[data-tab="' + tab_content_name + '"]')
        .text($(this).val());
    }
  );
  ...
  $(document).on(
    "click",
    ".qtag_button_hover_option .button_hover_type1",
    function (event) {
  ...
  $(document).on(
    "click",
    ".qtag_button_hover_option .button_hover_type2, .qtag_button_hover_option .button_hover_type3",
    function (event) {
  ...
  $(document).on(
    "click",
    ".qtag_button_hover_option .button_hover_type4",
    function (event) {
      $(this).closest(".button_option").find(".hide_bg_color").hide();
  ...
  $(document).on(
    "click",
    ".mobile_index_content_type1_button",
    function (event) {
  ...
  $(document).on(
    "click",
    ".mobile_index_content_type2_button",
    function (event) {
  ...
  $(document).on(
    "click",
    ".mobile_index_content_type3_button",
    function (event) {
      $(".mobile_index_content_type1_option").hide();
      $(".mobile_index_content_type2_option").hide();
  ...
  $(document).on(
    "click",
    "#mobile_show_index_slider_type2_button",
    function (event) {
  ...
  $(document).on(
    "click",
    "#mobile_show_index_slider_type1_button, #mobile_show_index_slider_type3_button",
    function (event) {
  ...
  $(document).on("click", ".index_slider_item_type1", function (event) {
    ...
    $(this)
      .closest(".sub_box_content")
      .find(".index_slider_youtube_area")
      .hide();
    $(this)
      .closest(".sub_box_content")
      .find(".index_slider_video_image")
      .hide();
  });
  ...
  $(document)
    .on(
      "change",
      "select#page_template, .editor-page-attributes__template select",
      function () {
        if ($(this).val() == "page-tcd-lp.php") {
          show_lp_meta_box();
        } else {
  ...
  $(document).on(
    "click",
    ".stop_index_slider_animation:checkbox",
    function (event) {
      if ($(this).is(":checked")) {
        $(this)
          .closest(".theme_option_field")
          .find(".index_slider_time .no_animation")
          .show();
        $(this)
          .closest(".theme_option_field")
          .find(".index_slider_time option[value='5000']")
          .prop("selected", true);
      } else {
        $(this)
          .closest(".theme_option_field")
  ...
  $("select.button_type_option").change(function () {
    if ($(this).val() == "type4") {
      $(this)
        .closest(".button_option_area")
        .find(".button_type4_option")
        .hide();
      ...
      $(this)
        .closest(".button_option_area")
        .find(".button_type1_option")
        .show();
      $(this)
        .closest(".button_option_area")
        .find(".button_type2_option")
        .hide();
    } else {
      $(this)
        .closest(".button_option_area")
  ...
  $(document).on(
    "click",
    ".use_main_color_checkbox input:checkbox",
    function (event) {
      if ($(this).is(":checked")) {
  ...
  $(document).on(
    "click",
    ".displayment_checkbox input:checkbox",
    function (event) {
      if ($(this).is(":checked")) {
  ...
  $(document).on(
    "click",
    ".displayment_checkbox2 input:checkbox",
    function (event) {
      if ($(this).is(":checked")) {
  ...
  $(document).on(
    "click",
    ".displayment_checkbox_cf input:checkbox",
    function (event) {
      if ($(this).is(":checked")) {
  ...
  $(document).on(
    "click",
    ".gmap_custom_marker_type_button_type1",
    function (event) {
      $(this)
        .closest(".gmap_marker_type2_area")
        .find(".gmap_custom_marker_type1_area")
        .show();
      $(this)
        .closest(".gmap_marker_type2_area")
        .find(".gmap_custom_marker_type2_area")
        .hide();
    }
  );
  $(document).on(
    "click",
    ".gmap_custom_marker_type_button_type2",
    function (event) {
      $(this)
        .closest(".gmap_marker_type2_area")
        .find(".gmap_custom_marker_type1_area")
  ...
  $(".select_logo_type .logo_type_option_type1").click(function () {
    $(this)
      .closest(".theme_option_field_ac_content")
      .find(".logo_text_area")
      .show();
    $(this)
      .closest(".theme_option_field_ac_content")
      .find(".logo_image_area")
      .hide();
  });
  ...
  $(document).on("click", "#hover_type_type5", function (event) {
    $(
      "#hover_type1_area, #hover_type2_area, #hover_type3_area, #hover_type4_area"
    ).hide();
  });
  ...
  $(document).on("change keyup", ".sub_box .repeater-label", function () {
    $(this)
      .closest(".sub_box")
      .find(".theme_option_subbox_headline:first")
      .text($(this).val());
  });
  ...
  // テーマオプションの入力エリアの開閉
  $(".theme_option_field_ac:not(.theme_option_field_ac.open)").on(
    "click",
  ...
  $(".cb_add_row_buttton_area .add_row").click(function () {
    var clone_html = $(this)
      .closest(".contents_builder_wrap")
      .find(".contents_builder-clone > .cb_row")
      .get(0).outerHTML;
    clone_html = clone_html.replace(/cb_cloneindex/g, "add_" + clone_next + "");
    clone_next++;
    $(this)
      .closest(".contents_builder_wrap")
      .find(".contents_builder")
      .append(clone_html);
  });
  ...
  $(".contents_builder").on("change", ".cb_content_select", function () {
    ...
    var $clone = $(this)
      .closest(".contents_builder_wrap")
      .find(".contents_builder-clone > ." + $(this).val());
    ...
    if ($cb_column.find(".cb_content .wp-editor-area").length) {
      ...
      $clone.find(".cb_content .wp-editor-area").each(function () {
        ...
        if (typeof tinyMCEPreInit.mceInit[id_clone] != "undefined") {
          ...
          var mce_init_new = $.extend(
            true,
            {},
            tinyMCEPreInit.mceInit[id_clone]
          );
          mce_init_new.body_class = mce_init_new.body_class.replace(
            /cb_cloneindex/g,
            cb_index
          );
          mce_init_new.selector = mce_init_new.selector.replace(
            /cb_cloneindex/g,
            cb_index
          );
        ...
        if (typeof tinyMCEPreInit.qtInit[id_clone] != "undefined") {
          ...
          try {
            if (QTags.instances["0"].theButtons) {
              QTags.instances[id_new].theButtons =
                QTags.instances["0"].theButtons;
            }
          } catch (err) {}
        }
    ...
    $(document).on(
      "click",
      ".show_banner_content_data2_option",
      function (event) {
        if ($(this).is(":checked")) {
  ...
  $(".contents_builder").on(
    "change",
    ".cb_content_switch input:checkbox",
    function () {
  ...
  $(".contents_builder").on(
    "change",
    ".custom_content_switch input:checkbox",
    function () {
      $(this).closest(".custom_content_wrap").toggleClass("off");
    }
  );
  $(".custom_content_switch input:checkbox").each(function () {
    if ($(this).is(":checked")) {
      $(this).closest(".custom_content_wrap").removeClass("off");
    } else {
      $(this).closest(".custom_content_wrap").addClass("off");
    }
  });
  ...
  $(document).on(
    "change keyup",
    ".cb_content_wrap .cb-repeater-label",
    function () {
  ...
  var init_repeater = function (el) {
    $(el).each(function () {
      ...
      var next_index =
        $repeater_wrapper.find(".repeater:first > .repeater-item").length || 0;
      ...
      // 新しいアイテムを追加する
      $repeater_wrapper
        .off("click", ".button-add-row")
        .on("click", ".button-add-row", function () {
          ...
          if (clone && $parent.size()) {
            ...
            if ($clone.find(".wp-editor-area").length) {
              ...
              $clone.find(".wp-editor-area").each(function () {
                ...
                if (typeof tinyMCEPreInit.qtInit[id_clone] != "undefined") {
                  // オブジェクトを=で代入すると参照渡しになるため$.extendを利用
                  var qt_init_new = $.extend(
                    true,
                    {},
                    tinyMCEPreInit.qtInit[id_clone]
                  );
          ...
          if (
            $repeater_wrapper.find(
              ".repeater-wrapper:not(.repeater-initialized)"
            ).length
          ) {
            init_repeater(
              $repeater_wrapper.find(
          ...
          $("select.button_animation_option").change(function () {
            if ($(this).val() == "type1") {
              $(this)
                .closest(".sub_box_content")
                .find(".button_animation_option_type1")
                .show();
              $(this)
                .closest(".sub_box_content")
                .find(".button_animation_option_type2")
                .hide();
            } else {
              $(this)
                .closest(".sub_box_content")
      ...
      $repeater_wrapper.on("click", ".button-delete-row", function () {
        var del = true;
        var confirm_message = $(this)
          .closest(".repeater")
          .attr("data-delete-confirm");
        if (confirm_message) {
  ...
  $(document).on(
    "change keyup",
    ".theme_option_subbox_headline_label",
    function () {
      $(this)
        .closest(".sub_box_content")
        .prev()
  ...
  if ($themeOptionsForm.length) {
      ...
      $inputs.each(function () {
        if ($(this).is("select")) {
          ...
          if (
            ...
            $(this)
              .closest("form")
              .find('input[name="' + this.name + '"]').length == 1
          ) {
            $(this).before(
      ...
      if ($(el).attr("data-sortable-changed")) {
        ...
        $inputs.each(function () {
          if ($(this).is("select")) {
            ...
            if (
              $(this).is(":checked") &&
              !$(this).attr("data-current-checked")
            ) {
              hasChange = true;
              return false;
            } else if (
    ...
    $themeOptionsForm.on("sortupdate", ".ui-sortable", function (event, ui) {
      // 更新フラグセット
      $themeOptionsForm
        .find(".tab-content:visible")
        .attr("data-sortable-changed", 1);
    });
    ...
    $themeOptionsForm.on("click", ".ajax_button", function () {
      ...
      $.ajax({
        ...
        success: function (data, textStatus, XMLHttpRequest) {
          $("#saving_data").hide();
          $("#saved_data").html(
            '<div id="saveMessage" class="successModal"></div>'
          );
          $("#saveMessage")
            .append("<p>" + TCD_MESSAGES.ajaxSubmitSuccess + "</p>")
            .show();
          setTimeout(function () {
  ...
  function logo_preview() {
    ...
    $("[data-logo-width-input]").each(function (i) {
      ...
      lpObj.$preview
        .html("")
        .append(lpObj.$logo)
        .append(lpObj.$Overlay)
        .append(lpObj.$catchBg);
    ...
    var logoPreviewChange = function () {
      for (var i = 0; i < logoPreviewVars.length; i++) {
        ...
        if (lpObj.$logoImg.length) {
          ...
          // 変更後画像読み込み完了
          if (
            lpObj.logoImg.src !== lpObj.logoImgSrc &&
            lpObj.logoImg.width > 0
          ) {
            isChange = true;
            ...
            lpObj.$logo
              .html('<img src="' + lpObj.logoImgSrc + '" alt="" />')
              .attr("data-origin-width", lpObj.logoImg.width)
              .append(
                '<div class="slider_logo_preview-logo-border-e"></div><div class="slider_logo_preview-logo-border-n"></div><div class="slider_logo_preview-logo-border-s"></div><div class="slider_logo_preview-logo-border-w"></div></div>'
              );
            ...
            lpObj.$logo.resizable({
              ...
              stop: function (event, ui) {
                ...
                $(
                  $(this)
                    .closest("[data-logo-width-input]")
                    .attr("data-logo-width-input")
                ).val(parseInt(ui.size.width, 10));
              },
            });
          }
        ...
        if (lpObj.$displayOverlay.is(":checked")) {
          ...
          if (overlayColor && overlayOpacity > 0) {
            ...
            if (overlayColor.length >= 6) {
              ...
              rgba.push(
                parseInt(
                  overlayColor.substring(0, 1) + overlayColor.substring(0, 1),
                  16
                )
              );
              rgba.push(
                parseInt(
                  overlayColor.substring(1, 2) + overlayColor.substring(1, 2),
                  16
                )
              );
              rgba.push(
                parseInt(
                  overlayColor.substring(2, 3) + overlayColor.substring(2, 3),
                  16
                )
              );
              rgba.push(overlayOpacity);
        ...
        if (lpObj.$displayCatchBg.is(":checked")) {
          ...
          if (catchBgColor && catchBgOpacity > 0) {
            ...
            if (catchBgColor.length >= 6) {
              ...
              rgba.push(
                parseInt(
                  catchBgColor.substring(0, 1) + catchBgColor.substring(0, 1),
                  16
                )
              );
              rgba.push(
                parseInt(
                  catchBgColor.substring(1, 2) + catchBgColor.substring(1, 2),
                  16
                )
              );
              rgba.push(
                parseInt(
                  catchBgColor.substring(2, 3) + catchBgColor.substring(2, 3),
                  16
                )
              );
              rgba.push(catchBgOpacity);
  ...
  $(".user_profile_image_url_field .delete-button").on("click", function () {
    if ($(this).attr("data-meta-key")) {
      ...
      $cl.append(
        '<input type="hidden" name="delete-image-' +
          $(this).attr("data-meta-key") +
          '" value="1">'
      );
  ...
  if ($(".cb_content_wrap.review").length) {
    // datepicker
    $(".cb_content_wrap.review .item_list_date").datepicker({
      dateFormat: "yy-mm-dd",
    });
    ...
    $(document).on(
      "focus",
      ".cb_content_wrap.review .item_list_date:not(.hasDatepicker)",
      function () {
    ...
    $(document).on(
      "change",
      ".cb_content_wrap.review .checkbox-use_review_vote",
      function () {
        if (this.checked) {
          $(this)
            .closest(".cb_content_wrap.review")
            .find(".review_vote")
            .show();
        } else {
          $(this)
    ...
    $(".cb_content_wrap.review .checkbox-use_review_vote:checked").trigger(
      "change"
    );
  }
});
