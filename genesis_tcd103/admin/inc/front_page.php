...
<div id="tab-content-front-page" class="tab-content">
   ...
   <div class="theme_option_field cf theme_option_field_ac">
    <h3 class="theme_option_headline"><?php _e('Header content', 'tcd-genesis');  ?></h3>
    <div class="theme_option_field_ac_content header_content_setting_area tab_parent">

     <h4 class="theme_option_headline2"><?php _e( 'Layout', 'tcd-genesis' ); ?></h4>
     <div id="index_slider_layout">
      <?php echo tcd_admin_image_radio_button($options, 'index_slider_layout', $slider_layout_options) ?>
     </div>

     <h4 class="theme_option_headline2"><?php _e('Background type', 'tcd-genesis'); ?></h4>
     <ul class="design_radio_button horizontal clearfix">
      <li class="index_header_content_type1">
       ...
       <label for="index_header_content_type1"><?php _e('Image slider', 'tcd-genesis');  ?></label>
      </li>
      <li class="index_header_content_type2">
       ...
       <label for="index_header_content_type2"><?php _e('Video', 'tcd-genesis');  ?></label>
      </li>
      <li class="index_header_content_type3">
       ...
       <label for="index_header_content_type3"><?php _e('YouTube', 'tcd-genesis');  ?></label>
      </li>
     </ul>

     <div class="sub_box_tab">
      <div class="tab active" data-tab="tab1"><?php _e('Main content', 'tcd-genesis'); ?></div>
      <div class="tab" data-tab="tab2"><span class="index_header_content_type1_option"><?php _e('Image slider', 'tcd-genesis'); ?></span><span class="index_header_content_type2_option"><?php _e('Video', 'tcd-genesis'); ?></span><span class="index_header_content_type3_option"><?php _e('YouTube', 'tcd-genesis'); ?></span></div>
     </div>
     ...
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('Catchphrase', 'tcd-genesis'); ?></span><textarea class="full_width" cols="50" rows="3" name="dp_options[index_slider_catch]"><?php echo esc_textarea(  $options['index_slider_catch'] ); ?></textarea></li>
      <li class="cf"><span class="label"><?php _e('Font type of catchphrase', 'tcd-genesis'); ?></span><?php echo tcd_basic_radio_button($options, 'index_slider_catch_font_type', $font_type_options); ?></li>
      <li class="cf"><span class="label"><?php _e('Font size of catchphrase', 'tcd-genesis'); ?></span><?php echo tcd_font_size_option($options, 'index_slider_catch_font_size'); ?></li>
      <li class="cf"><span class="label"><?php _e('Description', 'tcd-genesis'); ?></span><textarea class="full_width" cols="50" rows="3" name="dp_options[index_slider_desc]"><?php echo esc_textarea(  $options['index_slider_desc'] ); ?></textarea></li>
      <li class="cf"><span class="label"><?php _e('Description (mobile)', 'tcd-genesis'); ?></span><textarea placeholder="<?php _e( 'Please indicate if you would like to display a short text for mobile sizes.', 'tcd-genesis' ); ?>" class="full_width" cols="50" rows="2" name="dp_options[index_slider_desc_mobile]"><?php echo esc_textarea(  $options['index_slider_desc_mobile'] ); ?></textarea></li>
      <li class="cf"><span class="label"><?php _e('Font size of description', 'tcd-genesis'); ?></span><?php echo tcd_font_size_option($options, 'index_slider_desc_font_size'); ?></li>
     </ul>
     ...
     <ul class="option_list">
      <li class="cf">
       <span class="label"><?php _e( 'Image', 'tcd-genesis' ); ?>
         <span class="recommend_desc header_slider_layout1_option"><?php printf(__('Recommend image size. Width:%1$spx, Height:%2$spx.', 'tcd-genesis'), '1450', '600'); ?></span>
         <span class="recommend_desc header_slider_layout3_option"><?php printf(__('Recommend image size. Width:%1$spx, Height:%2$spx.', 'tcd-genesis'), '1450', '1100'); ?></span>
      ...
      <li class="cf">
       <span class="label"><?php _e( 'Image (mobile)', 'tcd-genesis' ); ?>
        <span class="recommend_desc"><?php printf(__('Recommend image size. Width:%1$spx, Height:%2$spx.', 'tcd-genesis'), '750', '1050'); ?></span>
       </span>
       <?php echo tcd_multi_media_uploader( 'index_slider_image_sp', $options ); ?>
      </li>
      <li class="cf">
       <span class="label"><?php _e('Slide type', 'tcd-genesis');  ?>
         <span class="recommend_desc"><?php _e('Applies when multiple images are set.', 'tcd-genesis'); ?></span>
       </span>
       <div class="standard_radio_button">
        <input id="index_header_slide_type1" type="radio" name="dp_options[index_header_slide_type]" value="slide_up" <?php checked( $options['index_header_slide_type'], 'slide_up' ); ?>>
        <label for="index_header_slide_type1"><?php _e('Slide up', 'tcd-genesis'); ?></label>
        <input id="index_header_slide_type2" type="radio" name="dp_options[index_header_slide_type]" value="fade" <?php checked( $options['index_header_slide_type'], 'fade' ); ?>>
        <label for="index_header_slide_type2"><?php _e('Fade', 'tcd-genesis'); ?></label>
       </div>
      </li>
      <li class="cf">
       <span class="label"><?php _e('Effect', 'tcd-genesis');  ?></span>
       <div class="standard_radio_button">
        <input id="index_header_slide_effect1" type="radio" name="dp_options[index_header_slide_effect]" value="zoom_out" <?php checked( $options['index_header_slide_effect'], 'zoom_out' ); ?>>
        <label for="index_header_slide_effect1"><?php _e('Zoom out', 'tcd-genesis'); ?></label>
        <input id="index_header_slide_effect2" type="radio" name="dp_options[index_header_slide_effect]" value="zoom_in" <?php checked( $options['index_header_slide_effect'], 'zoom_in' ); ?>>
        <label for="index_header_slide_effect2"><?php _e('Zoom in', 'tcd-genesis'); ?></label>
        <input id="index_header_slide_effect3" type="radio" name="dp_options[index_header_slide_effect]" value="none" <?php checked( $options['index_header_slide_effect'], 'none' ); ?>>
        <label for="index_header_slide_effect3"><?php _e('No effect', 'tcd-genesis'); ?></label>
       </div>
      </li>
     </ul>
     ...
     <div class="theme_option_message2" style="margin-top:25px;">
      <p><?php _e('Please upload MP4 format file.', 'tcd-genesis');  ?><br>
      ...
      <?php _e('Recommended MP4 file size: 10 MB or less.<br>The screen ratio of the video is assumed to be 16:9.', 'tcd-genesis'); ?></p>
     </div>
     <div class="cf cf_media_field hide-if-no-js index_header_content_video">
      ...
      <div class="preview_field preview_field_video">
       ...
       <h4><?php _e( 'Uploaded MP4 file', 'tcd-genesis' ); ?></h4>
       <p><?php echo esc_url(wp_get_attachment_url($options['index_header_content_video'])); ?></p>
       <?php }; ?>
      </div>
      <div class="buttton_area">
       <input type="button" value="<?php _e('Select MP4 file', 'tcd-genesis'); ?>" class="cfmf-select-video button">
       <input type="button" value="<?php _e('Remove MP4 file', 'tcd-genesis'); ?>" class="cfmf-delete-video button <?php if(!$options['index_header_content_video']){ echo 'hidden'; }; ?>">
      </div>
     </div>
     ...
     <div class="theme_option_message2" style="margin-top:25px;">
      <p><?php _e('Please enter YouTube URL.', 'tcd-genesis');  ?></p>
      <p><?php _e('Web browser takes few second to load the data of video so we recommend to use loading screen if you want to display video.', 'tcd-genesis'); ?></p>
     </div>
     ...
     <h4 class="theme_option_headline2"><?php _e('Overlay', 'tcd-genesis'); ?></h4>
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('Color', 'tcd-genesis'); ?></span><input type="text" name="dp_options[index_header_content_overlay_color]" value="<?php echo esc_attr( $options['index_header_content_overlay_color'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
      <li class="cf">
       <span class="label"><?php _e('Transparency of overlay', 'tcd-genesis'); ?></span><input class="hankaku" style="width:70px;" type="number" step="0.1" name="dp_options[index_header_content_overlay_opacity]" value="<?php echo esc_attr( $options['index_header_content_overlay_opacity'] ); ?>" />
   ...
   <div class="theme_option_field theme_option_field_ac open active <?php if($options['index_content_type'] == 'type1') { echo 'show_arrow'; }; ?>">
    <h3 class="theme_option_headline"><?php _e('Content builder', 'tcd-genesis');  ?></h3>
    <div class="theme_option_field_ac_content">
     ...
     <ul class="design_radio_button" style="margin-bottom:25px;">
      <li class="index_content_type1_button">
       ...
       <label for="index_content_type1"><?php _e('Use content builder', 'tcd-genesis');  ?></label>
      </li>
      <li class="index_content_type2_button">
       ...
       <label for="index_content_type2"><?php _e('Use page content instead of content builder', 'tcd-genesis');  ?></label>
      </li>
     </ul>
     ...
     <div class="index_content_type2_option" style="<?php if($options['index_content_type'] == 'type2') { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
      <div class="theme_option_message2">
       <p><?php printf(__('Please set content from <a href="post.php?post=%s&action=edit" target="_blank">Front page edit screen</a>.', 'tcd-genesis'), $front_page_id); ?></p>
      </div>
      <h4 class="theme_option_headline2"><?php _e('Content width', 'tcd-genesis');  ?></h4>
      <ul class="option_list">
       <li class="cf">
        <span class="label"><?php _e('Content width type', 'tcd-genesis'); ?></span>
        <div class="standard_radio_button">
         ...
         <label for="page_content_width_type1"><?php _e('Any width', 'tcd-genesis'); ?></label>
         ...
         <label for="page_content_width_type2"><?php _e('Full screen width', 'tcd-genesis'); ?></label>
        </div>
       </li>
       <li class="cf page_content_width_type1_option" style="<?php if($options['page_content_width_type'] == 'type1'){ echo 'display:block;'; } else {  echo 'display:none;'; }; ?>">
        <span class="label"><?php _e('Content width', 'tcd-genesis'); ?></span><input class="hankaku page_content_width_input" style="width:100px;" type="number" name="dp_options[page_content_width]" value="<?php echo esc_attr($options['page_content_width']); ?>" /><span>px</span>
       </li>
      </ul>
      <ul class="button_list cf">
       <li><input type="submit" class="button-ml ajax_button" value="<?php echo __( 'Save Changes', 'tcd-genesis' ); ?>" /></li>
     ...
     <div class="index_content_type1_option" style="<?php if($options['index_content_type'] == 'type1') { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
      ...
      <div class="theme_option_message no_arrow">
       ...
       <br>
       <p><?php _e('For headline and description that do not have font type or font size options, please adjust all at once from the font setting section of the basic settings ', 'tcd-genesis');  ?></p>
      </div>
      <ul class="design_button_list cf">
       <li><a data-rel="lightcase:indexcb" href="<?php bloginfo('template_url'); ?>/admin/img/cb_design_content2.jpg" title="<?php _e('Design banner', 'tcd-genesis'); ?>"><?php _e('Design banner', 'tcd-genesis'); ?></a></li>
       <li><a data-rel="lightcase:indexcb" href="<?php bloginfo('template_url'); ?>/admin/img/cb_service_list2.jpg" title="<?php printf(__('%s list', 'tcd-genesis'), $service_label); ?>"><?php printf(__('%s list', 'tcd-genesis'), $service_label); ?></a></li>
       <li><a data-rel="lightcase:indexcb" href="<?php bloginfo('template_url'); ?>/admin/img/cb_blog_list2.jpg" title="<?php printf(__('%s list', 'tcd-genesis'), $blog_label); ?>"><?php printf(__('%s list', 'tcd-genesis'), $blog_label); ?></a></li>
       <li><a data-rel="lightcase:indexcb" href="<?php bloginfo('template_url'); ?>/admin/img/cb_news_list2.jpg?2.0" title="<?php printf(__('%s list', 'tcd-genesis'), $news_label); ?>"><?php printf(__('%s list', 'tcd-genesis'), $news_label); ?></a></li>
      </ul>
     </div>
   ...
   <div class="contents_builder_wrap index_content_type1_option" style="<?php if($options['index_content_type'] == 'type1') { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
    ...
    <div class="contents_builder">
     <p class="cb_message"><?php _e( 'Click Add content button to start content builder', 'tcd-genesis' ); ?></p>
     <?php
     ...
     <div class="cb_row">
      <ul class="cb_button cf">
       <li><span class="cb_move"><?php echo __('Move', 'tcd-genesis'); ?></span></li>
       <li><span class="cb_delete"><?php echo __('Delete', 'tcd-genesis'); ?></span></li>
      </ul>
...
<?php
     ...
     if ($cb_content_select == 'design_content') {
       ...
       if (!isset($value['desc_mobile'])) { $value['desc_mobile'] = ''; }
       if (!isset($value['button_label'])) { $value['button_label'] = ''; }
       if (!isset($value['button_url'])) { $value['button_url'] = ''; }

       for ( $i = 1; $i <= 2; $i++ ) :
         if (!isset($value['item_headline'.$i])) { $value['item_headline'.$i] = ''; }
         if (!isset($value['overlay_color'.$i])) { $value['overlay_color'.$i] = '#000000'; }
         if (!isset($value['item_image'.$i])) { $value['item_image'.$i] = ''; }
         if (!isset($value['item_title'.$i])) { $value['item_title'.$i] = ''; }
         if (!isset($value['item_url'.$i])) { $value['item_url'.$i] = ''; }
       endfor;
?>

  <h3 class="cb_content_headline"><?php _e('Design banner', 'tcd-genesis'); ?><span class="cb_content_headline_sub_title"></span></h3>
  ...
  <div class="cb_content tab_parent">
   ...
   <div class="cb_content_switch_target">
    ...
    <ul class="option_list">
     <li class="cf"><span class="label"><span class="num">1</span><?php _e('Headline', 'tcd-genesis'); ?></span><input type="text" class="cb-repeater-label full_width" name="dp_options[contents_builder][<?php echo $cb_index; ?>][headline]" value="<?php echo esc_attr($value['headline']); ?>" /></li>
     <li class="cf"><span class="label"><span class="num">2</span><?php _e('Subheading', 'tcd-genesis'); ?></span><input type="text" class="full_width" name="dp_options[contents_builder][<?php echo $cb_index; ?>][sub_title]" value="<?php echo esc_attr($value['sub_title']); ?>" /></li>
     <li class="cf"><span class="label"><span class="num">3</span><?php _e('Description', 'tcd-genesis'); ?></span><textarea class="full_width" cols="50" rows="3" name="dp_options[contents_builder][<?php echo $cb_index; ?>][desc]"><?php echo esc_textarea(  $value['desc'] ); ?></textarea></li>
     <li class="cf"><span class="label"><span class="num">3</span><?php _e('Description (mobile)', 'tcd-genesis'); ?></span><textarea placeholder="<?php _e( 'Please indicate if you would like to display a short text for mobile sizes.', 'tcd-genesis' ); ?>" class="full_width" cols="50" rows="3" name="dp_options[contents_builder][<?php echo $cb_index; ?>][desc_mobile]"><?php echo esc_textarea(  $value['desc_mobile'] ); ?></textarea></li>
     <li class="cf"><span class="label"><span class="num">4</span><?php _e('Link button label', 'tcd-genesis'); ?></span><input type="text" class="full_width" name="dp_options[contents_builder][<?php echo $cb_index; ?>][button_label]" value="<?php echo esc_attr($value['button_label']); ?>" /></li>
     <li class="cf"><span class="label"><span class="num">4</span><?php _e('Link button url', 'tcd-genesis'); ?></span><input type="text" class="full_width" name="dp_options[contents_builder][<?php echo $cb_index; ?>][button_url]" value="<?php echo esc_attr($value['button_url']); ?>" /></li>
    </ul>

    <h4 class="theme_option_headline_number"><span class="num">5</span><?php _e('Banner', 'tcd-genesis');  ?></h4>
    <div class="sub_box_tab">
     <div class="tab active" data-tab="tab1"><?php _e('Left banner', 'tcd-genesis'); ?></div>
     <div class="tab" data-tab="tab2"><?php _e('Right banner', 'tcd-genesis'); ?></div>
    </div>
    ...
    <div class="sub_box_tab_content<?php if($i == 1){ echo ' active'; }; ?>" data-tab-content="tab<?php echo $i; ?>">
     ...
     <ul class="option_list">
      <li class="cf"><span class="label"><?php _e('Headline', 'tcd-genesis'); ?></span><input type="text" class="full_width" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_headline<?php echo $i; ?>]" value="<?php echo esc_attr($value['item_headline'.$i]); ?>" /></li>
      <li class="cf">
       <span class="label">
        <?php _e('Background image', 'tcd-genesis'); ?>
        <span class="recommend_desc"><?php printf(__('Recommend image size. Width:%1$spx, Height:%2$spx.', 'tcd-genesis'), '623', '450'); ?></span>
       </span>
       <div class="image_box cf">
        <div class="cf cf_media_field hide-if-no-js dc_bg_image_<?php echo $cb_index; ?>_<?php echo $i; ?>">
         <input type="hidden" value="<?php echo esc_attr($value['item_image'.$i]); ?>" id="dc_bg_image_<?php echo $cb_index; ?>_<?php echo $i; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_image<?php echo $i; ?>]" class="cf_media_id">
         ...
         <div class="buttton_area">
          ...
          <input type="button" value="<?php _e('Remove Image', 'tcd-genesis'); ?>" class="cfmf-delete-img button <?php if(!$value['item_image'.$i]){ echo 'hidden'; }; ?>">
         </div>
        </div>
       </div>
      </li>
      <li class="cf"><span class="label"><?php _e('Color of overlay', 'tcd-genesis'); ?></span><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][overlay_color<?php echo $i; ?>]" value="<?php echo esc_attr( $value['overlay_color'.$i] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
      <li class="cf"><span class="label"><?php _e('Link label', 'tcd-genesis'); ?></span><input type="text" class="full_width" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_title<?php echo $i; ?>]" value="<?php echo esc_attr($value['item_title'.$i]); ?>" /></li>
      <li class="cf"><span class="label"><?php _e('Link URL', 'tcd-genesis'); ?></span><input type="text" class="full_width" name="dp_options[contents_builder][<?php echo $cb_index; ?>][item_url<?php echo $i; ?>]" value="<?php echo esc_attr($value['item_url'.$i]); ?>" /></li>
     </ul>
...
<?php
     // サービス　-------------------------------------------------------------
       ...
       if (!isset($value['desc_mobile'])) { $value['desc_mobile'] = ''; }
       if (!isset($value['button_label'])) { $value['button_label'] = ''; }
       if (!isset($value['category_list'])) { $value['category_list'] = array(); }
       if (!isset($value['headline_font_size'])) { $value['headline_font_size'] = '50'; }
       if (!isset($value['headline_font_size_sp'])) { $value['headline_font_size_sp'] = '30'; }

?>

  <h3 class="cb_content_headline"><?php printf(__('%s list', 'tcd-genesis'), $service_label); ?><span class="cb_content_headline_sub_title"></span></h3>
  <label class="cb_content_switch"><div class="label_wrap"><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_content]" type="checkbox" value="1" <?php checked( $value['show_content'], 1 ); ?>><span class="label"><span class="on">ON</span><span class="sep"></span><span class="off">OFF</span></span></div></label>
  <div class="cb_content tab_parent">
   ...
   <div class="cb_content_switch_target">
    ...
    <ul class="option_list">
     ...
     <li class="cf"><span class="label"><span class="num">4</span><?php _e('Link button label', 'tcd-genesis'); ?></span><input type="text" class="full_width" name="dp_options[contents_builder][<?php echo $cb_index; ?>][button_label]" value="<?php echo esc_attr($value['button_label']); ?>" /></li>
     <li class="cf">
      <span class="label"><span class="num">5</span><?php _e('Font size of category headline', 'tcd-genesis'); ?></span>
      <div class="font_size_option">
       <label class="font_size_label number_option">
        <input class="hankaku input_font_size" type="number" name="dp_options[contents_builder][<?php echo $cb_index; ?>][headline_font_size]" value="<?php echo esc_attr( $value['headline_font_size'] ); ?>" />
        <span class="icon icon_pc"></span>
       </label>
       <label class="font_size_label number_option">
        <input class="hankaku input_font_size" type="number" name="dp_options[contents_builder][<?php echo $cb_index; ?>][headline_font_size_sp]" value="<?php echo esc_attr( $value['headline_font_size_sp'] ); ?>" />
    ...
    <div class="theme_option_message2">
     <p><?php printf(__('If you want to display a button for each %s article when hovering over a category,<br>Go to "TCD Theme option > %s > Archive page" and set the "Display Format" to "Type2".', 'tcd-genesis'), $service_label, $service_label); ?></p>
    </div>

    <h4 class="theme_option_headline2"><?php _e('Category', 'tcd-genesis');  ?></h4>
    ...
    ?>
    <div class="theme_option_message2">
     <p><?php printf(__('Please select %s category to display in front page.<br>Category will not be displayed when article is not registered.', 'tcd-genesis'), $service_label); ?></p>
    </div>
    <ul class="tag_check_list">
     ...
     <li>
      <label>
       <input name="dp_options[contents_builder][<?php echo $cb_index; ?>][category_list][]" type="checkbox" value="<?php echo esc_attr($cat_id); ?>" <?php checked( in_array( $cat_id, $value['category_list'] ), true ); ?> />
    ...
    <?php } else { ?>
    <div class="theme_option_message2">
     <p><?php printf(__('Please register %s category before using this option.', 'tcd-genesis'), $service_label); ?></p>
    </div>
    <?php }; ?>
...
<?php
     // ブログ一覧　-------------------------------------------------------------
       ...
       if (!isset($value['post_num_sp'])) { $value['post_num_sp'] = '5'; }
...
?>
  ...
  <h3 class="cb_content_headline"><?php printf(__('%s list', 'tcd-genesis'), $blog_label); ?><span class="cb_content_headline_sub_title"></span></h3>
  <label class="cb_content_switch"><div class="label_wrap"><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_content]" type="checkbox" value="1" <?php checked( $value['show_content'], 1 ); ?>><span class="label"><span class="on">ON</span><span class="sep"></span><span class="off">OFF</span></span></div></label>
   ...
   <div class="cb_content_switch_target">
    ...
    <ul class="option_list">
     ...
     <li class="cf">
      ...
      <div class="standard_radio_button">
       <input id="carousel_post_type_recent_post_<?php echo $cb_index; ?>" type="radio" name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_type]" value="recent_post" <?php checked( $value['post_type'], 'recent_post' ); ?>>
       <label for="carousel_post_type_recent_post_<?php echo $cb_index; ?>"><?php _e('Recent post', 'tcd-genesis'); ?></label>
       <input id="carousel_post_type_recommend_post_<?php echo $cb_index; ?>" type="radio" name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_type]" value="recommend_post" <?php checked( $value['post_type'], 'recommend_post' ); ?>>
       <label for="carousel_post_type_recommend_post_<?php echo $cb_index; ?>"><?php _e('Recommend post', 'tcd-genesis'); ?></label>
       <input id="carousel_post_type_recommend2_post_<?php echo $cb_index; ?>" type="radio" name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_type]" value="recommend_post2" <?php checked( $value['post_type'], 'recommend_post2' ); ?>>
       <label for="carousel_post_type_recommend2_post_<?php echo $cb_index; ?>"><?php _e('Recommend post', 'tcd-genesis'); ?>2</label>
       <input id="carousel_post_type_recommend3_post_<?php echo $cb_index; ?>" type="radio" name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_type]" value="recommend_post3" <?php checked( $value['post_type'], 'recommend_post3' ); ?>>
       <label for="carousel_post_type_recommend3_post_<?php echo $cb_index; ?>"><?php _e('Recommend post', 'tcd-genesis'); ?>3</label>
      </div>
     </li>
     <li class="cf">
      ...
      <div class="standard_radio_button">
       ...
       <label for="carousel_post_order_date_<?php echo $cb_index; ?>"><?php _e('Date', 'tcd-genesis'); ?></label>
       ...
       <label for="carousel_post_order_rand_<?php echo $cb_index; ?>"><?php _e('Random', 'tcd-genesis'); ?></label>
      </div>
     </li>
     <li class="cf">
      <span class="label"><?php _e('Number of post to display', 'tcd-genesis'); ?></span>
      <div class="display_post_num_option">
       <label for="cb_post_list_post_num_<?php echo $cb_index; ?>"><input type="number" id="cb_post_list_post_num_<?php echo $cb_index; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_num]" value="<?php echo esc_attr($value['post_num']); ?>"><span class="icon icon_pc"></span></label>
       <label for="cb_post_list_post_num_sp_<?php echo $cb_index; ?>"><input type="number" id="cb_post_list_post_num_sp_<?php echo $cb_index; ?>" name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_num_sp]" value="<?php echo esc_attr($value['post_num_sp']); ?>"><span class="icon icon_sp"></span></label>
      </div>
     </li>
    </ul>
...
?>
  ...
  <h3 class="cb_content_headline"><?php printf(__('%s list', 'tcd-genesis'), $news_label); ?><span class="cb_content_headline_sub_title"></span></h3>
  <label class="cb_content_switch"><div class="label_wrap"><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_content]" type="checkbox" value="1" <?php checked( $value['show_content'], 1 ); ?>><span class="label"><span class="on">ON</span><span class="sep"></span><span class="off">OFF</span></span></div></label>
  <div class="cb_content">
   ...
   <div class="cb_content_switch_target">
    ...
    <div class="theme_option_message2">
     <p><?php _e('Category sort button will automatically display when there is more than two categories registered.', 'tcd-genesis');  ?></p>
    </div>
...
<?php
     // フリースペース　-------------------------------------------------------------
       ...
       if (!isset($value['show_content'])) { $value['show_content'] = 1; }
       if (!isset($value['free_space'])) { $value['free_space'] = ''; }
       if (!isset($value['content_width'])) { $value['content_width'] = 'type1'; }

?>
  <h3 class="cb_content_headline"><?php _e('Free space', 'tcd-genesis'); ?><span class="cb_content_headline_sub_title"></span></h3>
  <label class="cb_content_switch"><div class="label_wrap"><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_content]" type="checkbox" value="1" <?php checked( $value['show_content'], 1 ); ?>><span class="label"><span class="on">ON</span><span class="sep"></span><span class="off">OFF</span></span></div></label>
  <div class="cb_content">
   ...
   <div class="cb_content_switch_target">
    ...
    <ul class="option_list">
     <li class="cf">
      <span class="label"><?php _e('Content width', 'tcd-genesis'); ?></span>
      <div class="standard_radio_button">
       <input id="cb_content_width_type1_<?php echo $cb_index; ?>" type="radio" name="dp_options[contents_builder][<?php echo $cb_index; ?>][content_width]" value="type1" <?php checked( $value['content_width'], 'type1' ); ?>>
       <label for="cb_content_width_type1_<?php echo $cb_index; ?>">1320px</label>
       <input id="cb_content_width_type2_<?php echo $cb_index; ?>" type="radio" name="dp_options[contents_builder][<?php echo $cb_index; ?>][content_width]" value="type2" <?php checked( $value['content_width'], 'type2' ); ?>>
       <label for="cb_content_width_type2_<?php echo $cb_index; ?>"><?php _e('Full size', 'tcd-genesis'); ?></label>
      </div>
     </li>
    </ul>

    <h4 class="theme_option_headline2"><?php _e('Content', 'tcd-genesis');  ?></h4>
    <?php
         wp_editor(
           $value['free_space'],
...
?>
   ...
   <ul class="button_list cf">
    <li><input type="submit" class="button-ml ajax_button" value="<?php echo __( 'Save Changes', 'tcd-genesis' ); ?>" /></li>
    <li><a href="#" class="button-ml close-content"><?php echo __( 'Close', 'tcd-genesis' ); ?></a></li>
   </ul>
