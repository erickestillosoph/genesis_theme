...
function add_protect_tab_label( $tab_labels ) {
	$tab_labels['protect'] = __( 'Password protected page', 'tcd-genesis' );
	return $tab_labels;
}
...
<div id="tab-content-protect" class="tab-content">
  ...
  <div class="theme_option_field cf theme_option_field_ac open active">
    <h3 class="theme_option_headline"><?php _e( 'Password protected pages', 'tcd-genesis' ); ?></h3>
    <div class="theme_option_field_ac_content">
      <h4 class="theme_option_headline2"><?php _e( 'Contents to encourage member registration', 'tcd-genesis' ); ?></h4>
      <?php for ( $i = 1; $i <= 3; $i++ ) : ?>
      <div class="sub_box">
        ...
        <div class="sub_box_content">
          ...
          <div class="theme_option_message2">
            <p><?php _e( '"Name of contents" is used in edit post page.', 'tcd-genesis' ); ?></p>
          </div>
          <h4 class="theme_option_headline2"><?php _e( 'Sentences to encourage member registration', 'tcd-genesis' ); ?></h4>
          <div class="theme_option_message2">
            <p><?php _e( '"Sentences to encourage member registration" is displayed under excerpts.', 'tcd-genesis' ); ?></p>
          </div>
          <?php wp_editor( $options['pw_editor' . $i], 'pw_editor' . $i, array ( 'textarea_name' => 'dp_options[pw_editor' . $i . ']' ) ); ?>
          <h4 class="theme_option_headline2"><?php _e( 'Password input field', 'tcd-genesis' ); ?></h4>
          <ul class="option_list">
            <li class="cf"><span class="label"><?php _e( 'Label of password field', 'tcd-genesis' ); ?></span><input class="full_width" type="text" name="dp_options[pw_label<?php echo $i; ?>]" value="<?php echo esc_attr( $options['pw_label' . $i] ); ?>"></li>
            <li class="cf"><span class="label"><?php _e( 'Name of password button', 'tcd-genesis' ); ?></span><input class="full_width" type="text" name="dp_options[pw_password_button_label<?php echo $i; ?>]" value="<?php echo esc_attr( $options['pw_password_button_label' . $i] ); ?>"></li>
          </ul>
        </div>
      </div>
      <?php endfor; ?>
