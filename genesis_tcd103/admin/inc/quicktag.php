...
function add_quicktag_tab_label( $tab_labels ) {
	$tab_labels['quicktag'] = __( 'Quick tag', 'tcd-genesis' );
	return $tab_labels;
}
...
function add_quicktag_dp_default_options( $dp_default_options ) {
  ...
  // ボタン1
	...
	$dp_default_options['qt_button1_color'] = '#ffffff';
	$dp_default_options['qt_button1_color2'] = $main_color;
	$dp_default_options['qt_button1_color_hover'] = '#ffffff';
	$dp_default_options['qt_button1_color2_hover'] = $hover_color;
  // ボタン2
  $dp_default_options['qt_button2_type'] = 'type1';
	...
	$dp_default_options['qt_button2_color'] = '#ffffff';
	$dp_default_options['qt_button2_color2'] = $main_color;
	$dp_default_options['qt_button2_color_hover'] = '#ffffff';
	$dp_default_options['qt_button2_color2_hover'] = $hover_color;
  // ボタン3
  $dp_default_options['qt_button3_type'] = 'type3';
	...
	$dp_default_options['qt_button3_color'] = '#ffffff';
	$dp_default_options['qt_button3_color2'] = $main_color;
	$dp_default_options['qt_button3_color_hover'] = '#ffffff';
	$dp_default_options['qt_button3_color2_hover'] = $hover_color;
  ...
  $dp_default_options['qt_speech_balloon1_user_image'] = '';
	$dp_default_options['qt_speech_balloon1_user_name'] = __('User name', 'tcd-genesis');
  ...
  // 吹き出し2
	...
	$dp_default_options['qt_speech_balloon2_user_name'] = __('User name', 'tcd-genesis');
  ...
  // 吹き出し3
	...
	$dp_default_options['qt_speech_balloon3_user_name'] = __('User name', 'tcd-genesis');
  ...
  // 吹き出し4
	...
	$dp_default_options['qt_speech_balloon4_user_name'] = __('User name', 'tcd-genesis');
...
<div id="tab-content-quicktag" class="tab-content">
  ...
  <div class="theme_option_field cf theme_option_field_ac open active">
    <h3 class="theme_option_headline"><?php _e('Activation', 'tcd-genesis');  ?></h3>
    <div class="theme_option_field_ac_content">
      <p><?php _e( 'If you don\'t want to use quicktags included in the theme, please uncheck the box below.', 'tcd-genesis' ); ?></p>
      <p><label><input name="dp_options[use_quicktags]" type="checkbox" value="1" <?php checked( 1, $options['use_quicktags'] ); ?>><?php _e( 'Use quicktags', 'tcd-genesis' ); ?></label></p>
  ...
  <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
      <div class="theme_option_message2">
        <p><?php _e( 'These settings will be reflected in the quick tag button on the edit screen.', 'tcd-genesis' ); ?></p>
      </div>

      <?php for ( $i = 2; $i <= 5; $i++ ) : ?>
      <div class="sub_box cf qt-hn-preview-wrapper">
        <h3 class="theme_option_subbox_headline"><?php printf( __( 'H%d tag', 'tcd-genesis' ), $i ); ?></h3>
        <div class="sub_box_content">

          <?php // 見出しのプレビュー ?>
          <div class="admin_preview_area qt-hn-preview">
						<div class="qt_heading"><span><?php _e('Headline design', 'tcd-genesis'); ?></span></div>
					</div>
          ...
          <h4 class="theme_option_headline2"><?php _e( 'Border setting', 'tcd-genesis' ); ?></h4>
          <ul class="option_list">
            <li class="cf"><span class="label"><?php _e('Display position', 'tcd-genesis'); ?></span>
            ...
            <li class="cf"><span class="label"><?php _e('Border style', 'tcd-genesis'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_h'.$i.'_border_style', $border_style_options); ?></li>
            ...
            <li class="cf">
              <span class="label"><?php _e('Border width', 'tcd-genesis'); ?></span>
          ...
          <div class="theme_option_message2">
            <p><?php _e( 'If you set the border style to "Double", please set the border width to 3px or more.', 'tcd-genesis' ); ?></p>
          </div>
      ...
      <div class="sub_box cf qt-btn-preview-wrapper">
        ...
        <div class="sub_box_content">
          ...
          <div class="admin_preview_area qt-btn-preview">
              ...
              <div class="qt_button type1"><span class="text"><?php _e('Normal', 'tcd-genesis'); ?></span><span class="background"></span></div>
							<div class="qt_button type2"><span class="text"><?php _e('Ghost', 'tcd-genesis'); ?></span><span class="background"></span></div>
							<div class="qt_button type3"><span class="text"><?php _e('Reverse', 'tcd-genesis'); ?></span><span class="background"></span></div>
						</div>
					</div>

          <h4 class="theme_option_headline2"><?php _e( 'Basic setting', 'tcd-genesis' ); ?></h4>
					<ul class="option_list">
						<li class="cf"><span class="label"><?php _e('Type', 'tcd-genesis'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_button'.$i.'_type', $button_type_options); ?></li>
						<li class="cf"><span class="label"><?php _e('Shape', 'tcd-genesis'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_button'.$i.'_border_radius', $button_border_radius_options); ?></li>
						<li class="cf"><span class="label"><?php _e('Size', 'tcd-genesis'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_button'.$i.'_size', $button_size_options); ?></li>
						<li class="cf"><span class="label"><?php _e('Mouseover animation', 'tcd-genesis'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_button'.$i.'_animation_type', $button_animation_options); ?></li>
						<li class="cf"><span class="label"><?php _e('Normal color', 'tcd-genesis'); ?></span><div class="font_color_picker"><input type="text" name="dp_options[qt_button<?php echo $i; ?>_color]" value="<?php echo esc_attr( $options['qt_button'.$i.'_color'] ); ?>" data-default-color="#ffffff" class="c-color-picker"></div><div class="bg_color_picker"><input type="text" name="dp_options[qt_button<?php echo $i; ?>_color2]" value="<?php echo esc_attr( $options['qt_button'.$i.'_color2'] ); ?>" data-default-color="<?php echo esc_attr($main_color); ?>" class="c-color-picker"></div></li>
						<li class="cf"><span class="label"><?php _e('Hover color', 'tcd-genesis'); ?></span><div class="font_color_picker_hover"><input type="text" name="dp_options[qt_button<?php echo $i; ?>_color_hover]" value="<?php echo esc_attr( $options['qt_button'.$i.'_color_hover'] ); ?>" data-default-color="#ffffff" class="c-color-picker"></div><div class="bg_color_picker_hover"><input type="text" name="dp_options[qt_button<?php echo $i; ?>_color2_hover]" value="<?php echo esc_attr( $options['qt_button'.$i.'_color2_hover'] ); ?>" data-default-color="<?php echo esc_attr($hover_color); ?>" class="c-color-picker"></div></li>
					</ul>
  ...
  <?php // 囲み枠 --------------------------------------------- ?>
  <div class="theme_option_field cf theme_option_field_ac">
    <h3 class="theme_option_headline"><?php _e('Frame style', 'tcd-genesis'); ?></h3>
    <div class="theme_option_field_ac_content">
      ...
      <div class="sub_box cf qt-frame-preview-wrapper">
        <h3 class="theme_option_subbox_headline"><?php echo __('Frame style', 'tcd-genesis').$i; ?></h3>
        <div class="sub_box_content">
          ...
          <div class="admin_preview_area qt-frame-preview">
              ...
              <p><?php _e('The frame has the effect of making the text stand out.</br>Labels can be displayed in the upper left corner.', 'tcd-genesis'); ?></p>
            </div>
					</div>

          <h4 class="theme_option_headline2"><?php _e('Label', 'tcd-genesis'); ?></h4>
          <ul class="option_list">
            <li class="cf"><span class="label"><?php _e('Label', 'tcd-genesis'); ?></span><input class="full_width" name="dp_options[qt_frame<?php echo $i; ?>_label]" type="text" value="<?php echo esc_attr( $options['qt_frame'.$i.'_label'] ); ?>"></li>
            <li class="cf"><span class="label"><?php _e('Font color', 'tcd-genesis'); ?></span><input type="text" name="dp_options[qt_frame<?php echo $i; ?>_label_color]" value="<?php echo esc_attr( $options['qt_frame'.$i.'_label_color'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
          </ul>
          <div class="theme_option_message2">
            <p><?php _e( 'Labels can also be changed from the edit screen of each article, and those set individually will take precedence.', 'tcd-genesis' ); ?></p>
          </div>

          <h4 class="theme_option_headline2"><?php _e('Basic setting', 'tcd-genesis'); ?></h4>
          <ul class="option_list">
            <li class="cf"><span class="label"><?php _e('Background color', 'tcd-genesis'); ?></span><input type="text" name="dp_options[qt_frame<?php echo $i; ?>_content_bg_color]" value="<?php echo esc_attr( $options['qt_frame'.$i.'_content_bg_color'] ); ?>" data-default-color="#ffffff" class="c-color-picker"></li>
            <li class="cf"><span class="label"><?php _e('Shape', 'tcd-genesis'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_frame'.$i.'_content_shape', $flame_border_radius_options); ?></li>
            <li class="cf">
              <span class="label"><?php _e('Border width', 'tcd-genesis'); ?></span>
              <label class="number_option">
            ...
            <li class="cf"><span class="label"><?php _e('Border color', 'tcd-genesis'); ?></span><input type="text" name="dp_options[qt_frame<?php echo $i; ?>_content_border_color]" value="<?php echo esc_attr( $options['qt_frame'.$i.'_content_border_color'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
            <li class="cf"><span class="label"><?php _e('Border style', 'tcd-genesis'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_frame'.$i.'_content_border_style', $border_style_options); ?></li>
          </ul>
          <div class="theme_option_message2">
            <p><?php _e( 'If you set the border style to "Double", please set the border width to 3px or more.', 'tcd-genesis' ); ?></p>
          </div>
          ...
          <ul class="button_list cf">
            <li><input type="submit" class="button-ml ajax_button" value="<?php _e('Save', 'tcd-genesis'); ?>" /></li>
  ...
  <?php // アンダーライン --------------------------------------------- ?>
  <div class="theme_option_field cf theme_option_field_ac">
    <h3 class="theme_option_headline"><?php _e('Underline', 'tcd-genesis'); ?></h3>
    <div class="theme_option_field_ac_content">
      <div class="theme_option_message2">
        <p><?php _e( 'These settings will be reflected in the quick tag button on the edit screen.', 'tcd-genesis' ); ?></p>
      </div>
      ...
      <div class="sub_box cf qt-ul-preview-wrapper">
        <h3 class="theme_option_subbox_headline"><?php echo __('Underline', 'tcd-genesis').$i;  ?></h3>
        <div class="sub_box_content">

          <div class="admin_preview_area qt-ul-preview">
						<div>
							<span class="qt_underline inactive"><?php _e('Sample text for underline.', 'tcd-genesis'); ?></span>
							<span class="qt_underline active"><?php _e('The animation will be executed when you scroll into the screen.', 'tcd-genesis'); ?></span>
						</div>
					</div>

          <h4 class="theme_option_headline2"><?php _e( 'Basic setting', 'tcd-genesis' ); ?></h4>
					<ul class="option_list">
						<li class="cf"><span class="label"><?php _e('Line color', 'tcd-genesis'); ?></span><input type="text" name="dp_options[qt_underline<?php echo $i; ?>_border_color]" value="<?php echo esc_attr( $options['qt_underline'.$i.'_border_color'] ); ?>" data-default-color="#fff799" class="c-color-picker"></li>
						...
						<li class="cf"><span class="label"><?php _e('Using animation', 'tcd-genesis'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_underline'.$i.'_use_animation', $bool_options); ?></li>
					</ul>
  ...
  <?php // 吹き出し --------------------------------------------- ?>
  <div class="theme_option_field cf theme_option_field_ac">
    <h3 class="theme_option_headline"><?php _e('Speech balloon', 'tcd-genesis');  ?></h3>
    <div class="theme_option_field_ac_content">
      <div class="theme_option_message2">
        <p><?php _e( 'These settings will be reflected in the quick tag button on the edit screen.', 'tcd-genesis' ); ?></p>
      </div>
      ...
      <div class="sub_box cf qt-sb-preview-wrapper preview_image_wrapper">
        ...
        <?php
            if ( 1 === $i ) _e( 'Speech balloon left 1', 'tcd-genesis' );
            elseif ( 2 === $i ) _e( 'Speech balloon left 2', 'tcd-genesis' );
            elseif ( 3 === $i ) _e( 'Speech balloon right 1', 'tcd-genesis' );
            elseif ( 4 === $i ) _e( 'Speech balloon right 2', 'tcd-genesis');
        ?>
        </h3>
        <div class="sub_box_content">
          ...
          <div class="admin_preview_area qt-sb-preview">
						<div class="qt_speech_bubble <?php if($i > 2) echo 'right'; ?>">
							...
							<div class="user">
								...
								<span class="name"><?php _e('User name', 'tcd-genesis'); ?></span>
							</div>
							<div class="content"><span class="before"></span><?php _e('The speech balloon can be set to a user name, image, and color.', 'tcd-genesis'); ?><span class="after"></span></div>							
						</div>
					</div>

          <h4 class="theme_option_headline2"><?php _e('Basic setting', 'tcd-genesis'); ?></h4>
          <ul class="option_list">
            <li class="cf"><span class="label"><?php _e('User name', 'tcd-genesis'); ?></span><input class="regular-text" name="dp_options[qt_speech_balloon<?php echo $i; ?>_user_name]" type="text" value="<?php echo esc_attr( $options['qt_speech_balloon'.$i.'_user_name'] ); ?>"></li>
            ...
            <li class="cf"><span class="label"><?php _e( 'User image', 'tcd-genesis' ); ?><span class="recommend_desc"><?php printf(__('Recommend image size. Width:%1$spx, Height:%2$spx.', 'tcd-genesis'), '80', '80'); ?></span></span><?php echo tcd_media_image_uploader($options, 'qt_speech_balloon'.$i.'_user_image', 'full'); ?></li>
          </ul>
  ...
  <div class="theme_option_field cf theme_option_field_ac qt-gm-preview-wrapper preview_image_wrapper">
    <h3 class="theme_option_headline"><?php _e( 'Google Maps', 'tcd-genesis' );  ?></h3>
    <div class="theme_option_field_ac_content">
    
      <div class="theme_option_message2">
        <p><?php _e('You can set styles of marker in Google maps using this option.', 'tcd-genesis');  ?></p>
      </div>
      ...
      <div id="qt_google_map">
        <div class="admin_preview_area qt-gm-preview">
          <div class="qt_gmap">
            ...
            <span class="marker custom text"><?php _e( 'MAP', 'tcd-genesis' ); ?></span>
      ...
      <h4 class="theme_option_headline2"><?php _e( 'Basic setting', 'tcd-genesis' ); ?></h4>
      <ul class="option_list">
        <li class="cf"><span class="label"><?php _e('API key', 'tcd-genesis'); ?></span><input class="full_width" type="text" name="dp_options[qt_gmap_api_key]" value="<?php echo esc_attr( $options['qt_gmap_api_key'] ); ?>" /></li>
        <li class="cf"><span class="label"><?php _e('Map design', 'tcd-genesis'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_access_saturation', $google_map_design_options); ?></li>
        <li class="cf"><span class="label"><?php _e('Marker type', 'tcd-genesis'); ?></span><?php echo tcd_basic_radio_button($options, 'qt_gmap_marker_type', $google_map_marker_options); ?></li>
      </ul>

      <h4 class="theme_option_headline2 qt_gmap_marker_type1"><?php _e( 'Custom marker setting', 'tcd-genesis' ); ?></h4>
      <ul class="option_list qt_gmap_marker_type1">
        ...
        <li class="cf qt_gmap_marker_type2"><span class="label"><?php _e('Images used for markers', 'tcd-genesis'); ?><span class="recommend_desc"><?php printf(__('Recommend image size. Width:%1$spx, Height:%2$spx.', 'tcd-genesis'), '60', '20'); ?></span></span><?php echo tcd_media_image_uploader($options, 'qt_gmap_marker_img', 'medium'); ?></li>
      </ul>

      <div class="theme_option_message2">
        <p><?php _e( 'In order to display Google Maps, you need to enter your API key. For details on how to obtain an API key, please see below.', 'tcd-genesis' ); ?></br><a href="https://tcd-theme.com/2018/08/google-maps-platform-api.html" target="_blank" rel="noopener noreferrer"><?php _e('How to get a Google Maps Platform API key and notes', 'tcd-genesis'); ?></a></p>
      </div>
...
function add_quicktag_theme_options_validate( $input ) {
  ...
  for ( $i = 1; $i <= 3; $i++ ) {
    ...
    $input['qt_button'.$i.'_color2'] = sanitize_hex_color( $input['qt_button'.$i.'_color2'] );
    $input['qt_button'.$i.'_color_hover'] = sanitize_hex_color( $input['qt_button'.$i.'_color_hover'] );
    $input['qt_button'.$i.'_color2_hover'] = sanitize_hex_color( $input['qt_button'.$i.'_color2_hover'] );
  }
