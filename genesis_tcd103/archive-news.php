...
<div class="news_category_button swiper">
 <ol class="swiper-wrapper">
  <li class="swiper-slide current"><a data-category-id="#ajax_post_cat_all" href="<?php echo esc_url(get_post_type_archive_link('news')); ?>"><?php _e('All post', 'tcd-genesis');  ?></a></li>
  <?php
  ...
  ?>
  <li class="swiper-slide"><a data-category-id="#ajax_post_cat_<?php echo esc_attr($cat_id); ?>" href="<?php echo esc_url($cat_url); ?>"><?php echo esc_html($cat_name); ?></a></li>
  <?php endforeach; ?>
 </ol>
</div>
<!--
