...
function get_post_views_post_types() {
	$post_views_post_types = array( 'post','news');
...
<p>
	...
	<label><input type="checkbox" name="edit_views" value="1" /><?php _e( 'Edit views', 'tcd-genesis' ); ?></label>
</p>
<script>
...
<?php
	...
	if ( USE_VIEWS_CUSTOM_FIELD && ! VIEWS_CUSTOM_FIELD_EDITABLE ) {
		$html .= '<tr><td>' . __( 'Total views', 'tcd-genesis' ) . '</td><td class="textright">' . intval( get_post_meta( $post->ID, '_views', true ) ) . "</td></tr>\n";
	} elseif ( ! USE_VIEWS_CUSTOM_FIELD && USE_VIEWS_RANGE_TABLE ) {
		$html .= '<tr><td>' . __( 'Total views', 'tcd-genesis' ) . '</td><td class="textright">' . get_post_views( $post->ID, '' ) . "</td></tr>\n";
	}

	if ( USE_VIEWS_RANGE_TABLE ) {
		$html .= '<tr><td>' . __( 'Daily views', 'tcd-genesis' ) . '</td><td class="textright">' . get_post_views( $post->ID, 'daily' ) . "</td></tr>\n";
		$html .= '<tr><td>' . __( 'Weekly views', 'tcd-genesis' ) . '</td><td class="textright">' . get_post_views( $post->ID, 'weekly' ) . "</td></tr>\n";
		$html .= '<tr><td>' . __( 'Monthly views', 'tcd-genesis' ) . '</td><td class="textright">' . get_post_views( $post->ID, 'monthly' ) . "</td></tr>\n";
		$html .= '<tr><td>' . __( 'Yearly views', 'tcd-genesis' ) . '</td><td class="textright">' . get_post_views( $post->ID, 'yearly' ) . "</td></tr>\n";
	}
	...
	<div class="inline-edit-col column-views">
		<div class="inline-edit-group">
			<label class="inline-edit-views" style="float:left;margin-right:1em;">
				<span class="title"><?php _e( 'Views', 'tcd-genesis' ); ?></span>
			...
			<label class="inline-edit-views" style="padding-top:0.2em;">
				<input type="checkbox" name="edit_views" value="1" /> <?php _e( 'Edit views', 'tcd-genesis' ); ?>
			</label>
		</div>
	</div>
</fieldset>
...
if ( SHOW_VIEWS_CUSTOM_FIELD_ADMIN_COLMUN && USE_VIEWS_CUSTOM_FIELD ) :
	...
	function cf_views_posts_columns( $columns ){
		$columns['views'] = __( 'Views', 'tcd-genesis' );
		return $columns;
	}
