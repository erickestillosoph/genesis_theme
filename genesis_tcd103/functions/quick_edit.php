  ...
  <div class="inline-edit-col column-meta-seo">
    <div class="inline-edit-group">
      <label class="inline-edit-tcd-w_meta_title">
        <span class="title"><?php _e('Title tag', 'tcd-genesis'); ?></span>
      ...
      <label class="inline-edit-tcd-w_meta_description">
        <span class="title" style="line-height:1.5;"><?php _e('Meta description tag', 'tcd-genesis');  ?></span>
...
<fieldset class="inline-edit-col-right">
  <div class="inline-edit-col column-recommend">
    <div class="inline-edit-group">
      <label style="line-height:1.5;"><input type="checkbox" name="recommend_post" value="on" /> <?php _e( 'Show this post for recommend post', 'tcd-genesis' );  ?></label>
      <label style="line-height:1.5;"><input type="checkbox" name="recommend_post2" value="on" /> <?php _e( 'Show this post for recommend post2', 'tcd-genesis' );  ?></label>
      <label style="line-height:1.5;"><input type="checkbox" name="recommend_post3" value="on" /> <?php _e( 'Show this post for recommend post3', 'tcd-genesis' );  ?></label>
    </div>
  </div>
</fieldset>
<?php
    ...
    // recommend news
    if ( $post_type == 'news' ) {
      echo '<input type="hidden" name="recommend_news_meta_box_nonce" value="', wp_create_nonce( 'recommend_news.php' ), '" />';
?>
<fieldset class="inline-edit-col-right">
  <div class="inline-edit-col column-recommend">
    <div class="inline-edit-group">
