...
?>
	...
	<div id="js-footer-bar-modal" class="modal-overlay p-footer-bar__modal">
		<ul class="p-footer-bar__modal-share">
			...
			<li class="p-footer-bar__modal-share-item">
				<a href="http://line.me/R/msg/text/?<?php echo rawurlencode( $title ); ?><?php echo rawurlencode( $url ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/img/line.png?2.0" alt=""></a>
			</li>
			<li class="p-footer-bar__modal-share-item">
				<a href="http://b.hatena.ne.jp/entry/" class="hatena-bookmark-button" data-hatena-bookmark-layout="simple" data-hatena-bookmark-width="100" data-hatena-bookmark-height="100" title="このエントリーをはてなブックマークに追加"><img src="<?php echo get_template_directory_uri(); ?>/img/hatena.png" alt="このエントリーをはてなブックマークに追加" width="400" height="400" style="border: none;" /></a><script type="text/javascript" src="https://b.st-hatena.com/js/bookmark_button.js" charset="utf-8" async="async"></script>
			</li>
		</ul>
