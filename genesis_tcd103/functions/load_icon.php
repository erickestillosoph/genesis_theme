...
<div id="site_loader_overlay">
 <div class="content">
  ...
  <div id="loader_logo_image">
   <?php if($logo_image) { ?><img <?php if($logo_image_mobile) { echo 'class="pc"'; }; ?> src="<?php echo esc_attr($logo_image[0]); ?>" alt="" title="" width="<?php echo esc_attr($image_width); ?>" height="<?php echo esc_attr($image_height); ?>" /><?php }; ?>
   <?php if($logo_image_mobile) { ?><img class="mobile" src="<?php echo esc_attr($logo_image_mobile[0]); ?>" alt="" title="" width="<?php echo esc_attr($image_width_mobile); ?>" height="<?php echo esc_attr($image_height_mobile); ?>" /><?php }; ?>
  </div>
  <?php }; ?>
  <?php if($options['loading_catch']){ ?>
  <p id="loader_catch" class="rich_font_<?php echo esc_attr($options['loading_catch_font_type']); ?>"><?php echo wp_kses_post(nl2br($options['loading_catch'])); ?></p>
  <?php }; ?>
 </div>
</div>
<?php
