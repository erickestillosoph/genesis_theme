...
#site_loader_overlay {
  ...
  opacity:1; background:<?php echo esc_attr($options['loading_bg_color']); ?>;
}
...
?>
<?php // キャッチフレーズ ?>
#loader_catch { opacity:0; text-align:center; line-height:1.8; padding:0 100px; font-size:<?php echo esc_html($loading_catch_font_size); ?>px; color:<?php echo esc_html($options['loading_catch_font_color']); ?>; }
#site_loader_overlay_for_catchphrase.start_loading #loader_catch { opacity:1; transition: opacity 1.0s ease 0.5s; }
@media screen and (max-width:1100px) {
  #loader_catch { font-size:<?php echo esc_attr(ceil($loading_catch_font_size_middle)); ?>px; padding:0 60px; }
}
@media screen and (max-width:800px) {
  #loader_catch { font-size:<?php echo esc_html($loading_catch_font_size_sp); ?>px; padding:0 20px; }
}
<?php // ロゴ ?>
...
#site_loader_overlay #loader_logo_image + #loader_catch { margin-top:30px; }
<?php // キャッチフレーズ ?>
