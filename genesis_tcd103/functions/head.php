...
function tcd_head()
{
  ...
  <style type="text/css">
    ...
    $super_headline_font_size = $options['super_headline_font_size'] ? $options['super_headline_font_size'] : '120';
    $super_headline_font_size_sp = $options['super_headline_font_size_sp'] ? $options['super_headline_font_size_sp'] : '60';
    ...
    .large_headline {
      font-size:<?php echo esc_html($headline_font_size); ?>px !important;
    }

    .super_large_headline {
      font-size:<?php echo esc_html($super_headline_font_size); ?>px !important;
    }

    .rich_font {
      font-size:<?php echo esc_html($catch_font_size); ?>px !important;
    }
    ...
    @media screen and (max-width:1100px) {
      ...
      .super_large_headline {
        font-size:<?php echo esc_html(floor(($super_headline_font_size + $super_headline_font_size_sp) / 1.8)); ?>px !important;
      }

      .rich_font {
        font-size:<?php echo esc_html(floor(($catch_font_size + $catch_font_size_sp) / 1.8)); ?>px !important;
      }
    }
    ...
    @media screen and (max-width:800px) {
      ...
      .large_headline {
        font-size:<?php echo esc_html($headline_font_size_sp); ?>px !important;
      }
      ...
      .rich_font {
        font-size:<?php echo esc_html($catch_font_size_sp); ?>px !important;
      }
    }

    @media screen and (max-width:370px) {
      .super_large_headline {
        font-size:<?php echo esc_html(floor(($super_headline_font_size + $super_headline_font_size_sp) / 2.8)); ?>px !important;
      }
    }
    ...
    ?>
    .logo_text {
      font-size:<?php echo esc_html($header_logo_font_size); ?>px;
    }

    @media screen and (max-width:1201px) {
      .logo_text {
        font-size:<?php echo esc_html($header_logo_font_size_sp); ?>px;
      }
    }
    ...
    if (!is_404()) {
      if ((is_front_page() && $options['show_header_message'] == 'display') || (!is_page() && $options['show_header_message'] == 'display') || (is_page() && !is_page_template('page-tcd-lp.php') && $options['show_header_message'] == 'display') || (is_page() && is_page_template('page-tcd-lp.php') && (get_post_meta($post->ID, 'hide_header_message', true)) == 'no')) {
        ...
        #header_message {
          background:
            <?php echo esc_attr($options['header_message_bg_color']); ?>
          ;
          color:
            <?php echo esc_attr($options['header_message_font_color']); ?>
          ;
        }
    ...
    @media screen and (max-width:1100px) {
      #footer_banner .title {
        font-size:<?php echo esc_html(floor(($footer_banner_title_font_size + $footer_banner_title_font_size_sp) / 1.8)); ?>px !important;
      }
    }

    @media screen and (max-width:800px) {
      #footer_banner .title {
        font-size:<?php echo esc_html($footer_banner_title_font_size_sp); ?>px !important;
      }
    }
      ...
      if ($options['hover_type'] == "type2") {
        ...
        @media(hover: hover) {
          .animate_background .image_wrap:before {
            ...
            pointer-events: none;
            opacity: 0;
            background: rgba(<?php echo esc_attr($hover3_bgcolor_hex); ?>,
                <?php echo esc_attr($options['hover3_opacity']); ?>
              );
            transition: opacity 0.3s ease;
          }

          .animate_background:hover .image_wrap:before {
            opacity: 1;
          }
        ...
        @media(hover: hover) {
          .animate_background .image_wrap:before {
            ...
            opacity: 0;
            background: rgba(<?php echo esc_attr($hover3_bgcolor_hex); ?>,
                <?php echo esc_attr($options['hover4_opacity']); ?>
              );
            transition: opacity 0.3s ease;
          }
    ...
    #no_search_result a {
      color:
        <?php echo esc_html($content_link_color); ?>
      ;
    }
    ...
    .textwidget a:hover,
    #no_post a:hover {
      color: rgba(<?php echo esc_html($content_link_color_hex); ?>, 0.6);
    }
    ...
    if ($options['use_quicktags']):
      ...
      for ($i = 2; $i <= 5; $i++) {
        ...
        .styled_h<?php echo $i ?> {
          font-size:
            <?php echo esc_attr($heading_font_size); ?>
            px !important;
          text-align:
            <?php echo esc_attr($heading_text_align); ?>
            !important;
          font-weight:
            <?php echo esc_attr($heading_font_weight); ?>
            !important;
          color:
            <?php echo esc_attr($heading_font_color); ?>
          ;
          border-color:
            <?php echo esc_attr($heading_border_color); ?>
          ;
          border-width:
            <?php echo esc_attr($heading_border_width); ?>
            px;
          border-style:
            <?php echo esc_attr($heading_border_style); ?>
          ;
          <?php
        ...
        @media screen and (max-width:800px) {
          .styled_h<?php echo $i ?> {
            font-size:
              <?php echo esc_attr($heading_font_size_sp); ?>
              px !important;
          }
        }
      ...
      for ($i = 1; $i <= 3; $i++) {
        ...
        ?>
        .post_content a.q_custom_button<?php echo $i; ?> {
          <?php echo $size . $shape . $colors[0]; ?>
        }

        .post_content a.q_custom_button<?php echo $i; ?>:before {
          <?php echo $colors[1] . $animations[0]; ?>
        }

        .post_content a.q_custom_button<?php echo $i; ?>:hover {
          <?php echo $colors[2]; ?>
        }

        .post_content a.q_custom_button<?php echo $i; ?>:hover:before {
          <?php echo $animations[1]; ?>
        }
      ...
      for ($i = 1; $i <= 3; $i++) {
        ...
        .q_frame<?php echo $i; ?> {
          ...
          ;
          border-style:
            <?php echo esc_attr($border_style); ?>
          ;
        }

        .q_frame<?php echo $i; ?> .q_frame_label {
          color:
            <?php echo esc_attr($label_color); ?>
          ;
        }
      ...
      for ($i = 1; $i <= 3; $i++) {
        ...
        .q_underline<?php echo $i; ?> {
          font-weight:
            <?php echo esc_attr($underline_font_weight); ?>
          ;
          background-image: -webkit-linear-gradient(left, transparent 50%,
              <?php echo esc_attr($underline_color); ?>
              50%);
          background-image: -moz-linear-gradient(left, transparent 50%,
              <?php echo esc_attr($underline_color); ?>
              50%);
          background-image: linear-gradient(to right, transparent 50%,
              <?php echo esc_attr($underline_color); ?>
              50%);
          <?php if ($underline_use_animation == 'no')
            echo 'background-position:-100% 0.8em;'; ?>
        }
      ...
      for ($i = 1; $i <= 4; $i++) {
        ...
        .speech_balloon<?php echo $i; ?> .speech_balloon_text_inner {
          color:
            <?php echo esc_attr($sb_font_color); ?>
          ;
          background-color:
            <?php echo esc_attr($sb_bg_color); ?>
          ;
          border-color:
            <?php echo esc_attr($sb_border_color); ?>
          ;
        }

        .speech_balloon<?php echo $i; ?> .before {
          border-left-color:
            <?php echo esc_attr($sb_border_color); ?>
          ;
        }

        .speech_balloon<?php echo $i; ?> .after {
          border-right-color:
            <?php echo esc_attr($sb_bg_color); ?>
          ;
        }
    ...
    .qt_google_map .pb_googlemap_custom-overlay-inner {
      background:
        <?php echo esc_attr($qt_gmap_marker_bg); ?>
      ;
      color:
        <?php echo esc_attr($options['qt_gmap_marker_color']); ?>
      ;
    }
  ...
  <style id="current-page-style" type="text/css">
    ...
    if (is_front_page()) {
      ...
      #header_slider_content .catch {
        font-size: <?php echo esc_attr($index_slider_catch_font_size); ?>px;
      }

      #header_slider_content .desc {
        font-size: <?php echo esc_attr($index_slider_desc_font_size); ?>px;
      }

      @media screen and (max-width:1100px) {
        #header_slider_content .catch {
          font-size: <?php echo esc_html(floor(($index_slider_catch_font_size + $index_slider_catch_font_size_sp) / 2)); ?>px;
        }

        #header_slider_content .desc {
          font-size: <?php echo esc_html(floor(($index_slider_desc_font_size + $index_slider_desc_font_size_sp) / 2)); ?>px;
        }
      }
      ...
      @media screen and (max-width:800px) {
        ...
        #header_slider_content .desc {
          font-size:<?php echo esc_attr($index_slider_desc_font_size_sp); ?>px;
        }
      }
        ...
        if ($contents_builder):
          ...
          foreach ($contents_builder as $content):
            ...
            if ($content['cb_content_select'] == 'service_list' && $content['show_content']) {
              ...
              ?>
              .cb_service_list.num<?php echo $content_count; ?> .item .headline {
                font-size:
                  <?php echo esc_html($headline_font_size); ?>
                  px;
              }
              ...
              @media (max-width: 1200px) {
                .cb_service_list.num<?php echo $content_count; ?> .item .headline {
                  font-size:
                    <?php echo esc_html($headline_font_size_sp); ?>
                    px;
                }
              }
      ...
      if ($overlay_opacity != '0') {
        ...
        ?>
        #page_header .overlay {
          background-color: rgba(<?php echo esc_attr($overlay_color); ?>,
      ...
      if (is_page_template('page-tcd-lp.php')) {
        ...
        #lp_page_header .catch {
          font-size:
            <?php echo esc_attr($catch_font_size); ?>
            px !important;
        }
        ...
        @media screen and (max-width:1100px) {
          #lp_page_header .catch {
            font-size:
              <?php echo esc_html(floor(($catch_font_size + $catch_font_size_sp) / 2)); ?>
              px !important;
          }
        }
        ...
        @media screen and (max-width:800px) {
          #lp_page_header .catch {
            font-size:
              <?php echo esc_attr($catch_font_size_sp); ?>
              px !important;
          }
        }
