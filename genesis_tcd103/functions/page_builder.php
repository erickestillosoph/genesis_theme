...
*/
	...
	for ($i = 1; $i <= 4; $i++) {
		...
		for ($j = 1; $j <= $i; $j++) {
			...
			$column_fields[$i] = array_merge($column_fields[$i], $box_inner, array(
				array(
					'name'      => __('Image', 'tcd-genesis'),
					'id'        => 'image'.$j,
					'type'      => 'image'
				),
				array(
					'name'      => __('Image position', 'tcd-genesis'),
					'id'        => 'image_type'.$j,
					'type'      => 'radio',
					'std'       => 'type1',
					'options'   => array(
						array('name' => __('Show at top', 'tcd-genesis'), 'value' => 'type1'),
						array('name' => __('Show at bottom', 'tcd-genesis'), 'value' => 'type2')
					)
				),
				array(
					'name'      => __('Link URL for image', 'tcd-genesis'),
					'id'        => 'link'.$j,
					'type'      => 'text'
				),
				array(
					'name'      => __('Link target', 'tcd-genesis'),
					'id'        => 'target_blank'.$j,
					'type'      => 'checkbox',
					'options'   => array(
						array('name' => __('Use target blank for this link', 'tcd-genesis'), 'value' => 'on')
					)
				),
				array(
					'name'      => __('Headline', 'tcd-genesis'),
					'id'        => 'headline'.$j,
					'type'      => 'text'
				),
				array(
					'name'      => __('Headline alignment', 'tcd-genesis'),
					'id'        => 'headline_align'.$j,
					'type'      => 'checkbox',
					'options'   => array(
						array('name' => __('Center align headline', 'tcd-genesis'), 'value' => 'on')
					)
				),
				array(
					'name'      => __('Description', 'tcd-genesis'),
					'id'        => 'content'.$j,
					'type'      => 'editor'
				)
			));
	...
	$page_builder_fields = array(
		// 1カラムレイアウト
		array(
			'name'      =>  __('1 column layout', 'tcd-genesis'),
			'id'        => 'one_column',
		...
		// 2カラムレイアウト
		array(
			'name'      =>  __('2 column layout', 'tcd-genesis'),
			'id'        => 'two_column',
		...
		// 3カラムレイアウト
		array(
			'name'      =>  __('3 column layout', 'tcd-genesis'),
			'id'        => 'three_column',
		...
		// 4カラムレイアウト
		array(
			'name'      =>  __('4 column layout', 'tcd-genesis'),
			'id'        => 'four_column',
		...
		// 画像リスト
		array(
			'name'      =>  __('Image list', 'tcd-genesis'),
			'id'        => 'image_list',
			'fields'    => array(
				array(
					'name'      => __('Image1', 'tcd-genesis'),
					'id'        => 'list_image1',
					'type'      => 'image'
				),
				array(
					'name'      => __('Image2', 'tcd-genesis'),
					'id'        => 'list_image2',
					'type'      => 'image'
				),
				array(
					'name'      => __('Image3', 'tcd-genesis'),
					'id'        => 'list_image3',
					'type'      => 'image'
				),
				array(
					'name'      => __('Image4', 'tcd-genesis'),
					'id'        => 'list_image4',
					'type'      => 'image'
				),
				array(
					'name'      => __('Image5', 'tcd-genesis'),
					'id'        => 'list_image5',
					'type'      => 'image'
				),
				array(
					'name'      => __('Image6', 'tcd-genesis'),
					'id'        => 'list_image6',
					'type'      => 'image'
				)
			)
		...
		// キャッチフレーズ
		array(
			'name'      =>  __('Catchphrase', 'tcd-genesis'),
			'id'        => 'catchphrase_set',
			'fields'    => array(
				array(
					'name'      => __('Catchphrase', 'tcd-genesis'),
				...
				array(
					'name'      => __('Font size of catchphrase', 'tcd-genesis'),
					'id'        => 'catchphrase_title_font_size',
					'std'       => '30',
					'type'      => 'text'
				),
				array(
					'name'      => __('Description under catchphrase', 'tcd-genesis'),
					'id'        => 'catchphrase_desc',
					'type'      => 'textarea'
				),
				array(
					'name'      => __('Font size of description', 'tcd-genesis'),
		...
		// Google Map
		array(
			'name'      =>  __('Google Map', 'tcd-genesis'),
			'id'        => 'google_map',
			'fields'    => array(
				array(
					'name'      => __('Google map type', 'tcd-genesis'),
					'id'        => 'map_type',
					'type'      => 'radio',
					'std'       => 'type1',
					'options'   => array(
						array('name' => __('Use Google map iframe code', 'tcd-genesis'), 'value' => 'type1'),
						array('name' => __('Use TCD Google Maps plugin', 'tcd-genesis'), 'value' => 'type2')
					)
				),
				array(
					'name'      => __('Google map iframe code', 'tcd-genesis'),
					'id'        => 'map_code1',
					'type'      => 'textarea'
				),
				array(
					'name'      => __('TCD Google Maps plugin short code', 'tcd-genesis'),
					'id'        => 'map_code2',
					'type'      => 'textarea'
				)
			)
		...
		// タブ
		array(
			'name'      =>  __('Tab', 'tcd-genesis'),
			'id'        => 'tab',
			'repeater_fields'    => array(
				array(
					'name'      => __('Name of this tab', 'tcd-genesis'),
					'id'        => 'tab_name',
					'type'      => 'text',
					'class'     => 'index_label'
				),
...
function render_page_builder_repeater_fields($fields, $field_input_id, $field_input_name, $post_id = -1) {
	...
	if ($row_count > 0) {
		...
		for($i = 1; $i <= $row_count; $i++) {
			...
			echo '<li><span class="pb_repeater_move">'.__('Move', 'tcd-genesis').'</span></li>'."\n";
			echo '<li><span class="pb_repeater_delete" data-confirm="'.__('Are you sure you want to delete this item?', 'tcd-genesis').'">'.__('Delete', 'tcd-genesis').'</span></li>'."\n";
			echo '</ul>'."\n";

			echo '<div class="pb_repeater_content">'."\n";
			echo '<h3 class="pb_repeater_headline"><span class="index_label">'.esc_html($index_label).'</span><a href="#">'.__('Open', 'tcd-genesis').'</a></h3>'."\n";
	...
	echo '<a href="#" class="pb_add_repeater button-ml">'.__('Add item', 'tcd-genesis').'</a>';
	echo '</div>'."\n";

	// 追加ボタン時に差し込むHTML
	$i = 'pb_repeater_add_index';
	if ($index_label_field) {
		$index_label = __('New item', 'tcd-genesis');
	} else {
		$index_label = $i;
	}
...
function page_builder_meta_box() {
	add_meta_box(
		...
		__('Page builder setting', 'tcd-genesis'),//label
...
?>
  ...
  <div class="pb_desc">
    <?php _e('<p>You can use designed HTML content by using this Page Builder function.<br />STEP:1  Click the blue button below.<br />STEP2:  Enter data in input field.<br />STEP3:  Copy and paste the short code to the post content area.</p>', 'tcd-genesis'); ?>
  </div>
		...
		foreach($pb_layouts as $pb_index => $pb_layout) {
			...
			foreach ($field_layouts as $field_layout) {
				...
				if ($field_layout['id'] == $pb_layout) {
					...
					echo '<h3 class="title">'.esc_html($field_layout['name']).'</h3><p class="short_code">[page_builder id=&quot;'.$pb_index.'&quot;]</p><a href="#" class="open">'. __('Open', 'tcd-genesis') .'</a>';
					echo '</div>'."\n";

					echo '<div class="pb_content">'."\n";

					echo '<div class="short_code"><span class="label">' . __('Copy and paste the short code below to the post content area.', 'tcd-genesis') . '</span><input type="text" value="[page_builder id=&quot;'.$pb_index.'&quot;]" readonly="readonly" /></div>'."\n";
					...
					echo '<a href="#" class="delete_button" data-confirm="'.__('Are you sure you want to delete this content?', 'tcd-genesis').'">'.__('Delete', 'tcd-genesis').'</a>';
					echo '</div>'."\n";
