...
function tcd_add_quicktags() {
	...
	$tcdQuicktagsL10n = array(
		'pulldown_title' => array(
			'display' => __( 'quicktags', 'tcd-genesis' ),
		),
		'ytube' => array(
			'display' => __( 'YouTube', 'tcd-genesis' ),
			'tag' => __( '<div class="ytube">YouTube code here</div>', 'tcd-genesis' )
		),
		'relatedcardlink' => array(
			'display' => __( 'Cardlink', 'tcd-genesis' ),
			'tag' => __( '[clink url="Post URL to display"]', 'tcd-genesis' )
		),
		'post_col-2' => array(
			'display' => __( '2 column', 'tcd-genesis' ),
			'tag' => __( '<div class="post_row"><div class="post_col post_col-2">Text and image tags to display in the left column</div><div class="post_col post_col-2">Text and image tags to display in the right column</div></div>', 'tcd-genesis' )
		),
		'post_col-3' => array(
			'display' => __( '3 column', 'tcd-genesis' ),
			'tag' => __( '<div class="post_row"><div class="post_col post_col-3">Text and image tags to display in the left column</div><div class="post_col post_col-3">Text and image tags to display in the center column</div><div class="post_col post_col-3">Text and image tags to display in the right column</div></div>', 'tcd-genesis' )
		),
		'q_comment_out' => array(
			'display' => __( 'Comment out', 'tcd-genesis' ),
			'tagStart' => '<div class="hidden"><!-- ',
			'tagEnd' => ' --></div>'
		),
		'q_h2' => array(
			'display' => __( 'Styled h2 tag', 'tcd-genesis' ),
			'tagStart' => '<h2 class="styled_h2">',
			'tagEnd' => '</h2>'
		),
		'q_h3' => array(
			'display' => __( 'Styled h3 tag', 'tcd-genesis' ),
			'tagStart' => '<h3 class="styled_h3">',
			'tagEnd' => '</h3>'
		),
		'q_h4' => array(
			'display' => __( 'Styled h4 tag', 'tcd-genesis' ),
			'tagStart' => '<h4 class="styled_h4">',
			'tagEnd' => '</h4>'
		),
		'q_h5' => array(
			'display' => __( 'Styled h5 tag', 'tcd-genesis' ),
			'tagStart' => '<h5 class="styled_h5">',
			'tagEnd' => '</h5>'
		),
		'q_ol' => array(
			'display' => __( 'Styled ol', 'tcd-genesis' ),
			'tag' => '<ol class="q_styled_ol">'."\n".'<li>'.__('List', 'tcd-genesis').'1</li>'."\n".'<li>'.__('List', 'tcd-genesis').'2</li>'."\n".'<li>'.__('List', 'tcd-genesis').'3</li>'."\n".'</ol>'
		),
		'q_frame1' => array(
			'display' => __( 'Frame style', 'tcd-genesis' ).'1',
			'tagStart' => '<div class="q_frame q_frame1"><span class="q_frame_label">'.esc_html($dp_options['qt_frame1_label']).'</span>',
			'tagEnd' => '</div>'
		),
		'q_frame2' => array(
			'display' => __( 'Frame style', 'tcd-genesis' ).'2',
			'tagStart' => '<div class="q_frame q_frame2"><span class="q_frame_label">'.esc_html($dp_options['qt_frame2_label']).'</span>',
			'tagEnd' => '</div>'
		),
		'q_frame3' => array(
			'display' => __( 'Frame style', 'tcd-genesis' ).'3',
		...
		'q_custom_button1' => array(
			'display' => sprintf( __( 'Button %d', 'tcd-genesis' ), 1 ),
			'tag' => '<div class="q_button_wrap"><a href="#" class="q_custom_button q_custom_button1">' . sprintf( __( 'Button %d', 'tcd-genesis' ), 1 ) . '</a></div>'
		),
		'q_custom_button2' => array(
			'display' => sprintf( __( 'Button %d', 'tcd-genesis' ), 2 ),
			'tag' => '<div class="q_button_wrap"><a href="#" class="q_custom_button q_custom_button2">' . sprintf( __( 'Button %d', 'tcd-genesis' ), 2 ) . '</a></div>'
		),
		'q_custom_button3' => array(
			'display' => sprintf( __( 'Button %d', 'tcd-genesis' ), 3 ),
			'tag' => '<div class="q_button_wrap"><a href="#" class="q_custom_button q_custom_button3">' . sprintf( __( 'Button %d', 'tcd-genesis' ), 3 ) . '</a></div>'
		),
		'q_underline1' => array(
			'display' => sprintf( __( 'Underline %d', 'tcd-genesis' ), 1 ),
			'tagStart' => '<span class="q_underline q_underline1" style="border-bottom-color:;">',
			'tagEnd' => '</span>'
		),
		'q_underline2' => array(
			'display' => sprintf( __( 'Underline %d', 'tcd-genesis' ), 2 ),
			'tagStart' => '<span class="q_underline q_underline2" style="border-bottom-color:;">',
			'tagEnd' => '</span>'
		),
		'q_underline3' => array(
			'display' => sprintf( __( 'Underline %d', 'tcd-genesis' ), 3 ),
			'tagStart' => '<span class="q_underline q_underline3" style="border-bottom-color:;">',
			'tagEnd' => '</span>'
		),
		'speech_balloon_left1' => array(
			'display' => __( 'Speech balloon left 1', 'tcd-genesis' ),
			'tagStart' => '<div class="sc">[speech_balloon_left1]',
			'tagEnd' => '[/speech_balloon_left1]</div>'
		),
		'speech_balloon_left2' => array(
			'display' => __( 'Speech balloon left 2', 'tcd-genesis' ),
			'tagStart' => '<div class="sc">[speech_balloon_left2]',
			'tagEnd' => '[/speech_balloon_left2]</div>'
		),
		'speech_balloon_right1' => array(
			'display' => __( 'Speech balloon right 1', 'tcd-genesis' ),
			'tagStart' => '<div class="sc">[speech_balloon_right1]',
			'tagEnd' => '[/speech_balloon_right1]</div>'
		),
		'speech_balloon_right2' => array(
			'display' => __( 'Speech balloon right 2', 'tcd-genesis' ),
			'tagStart' => '<div class="sc">[speech_balloon_right2]',
			'tagEnd' => '[/speech_balloon_right2]</div>'
		),
		'google_map' => array(
			'display' => __( 'Google map', 'tcd-genesis' ),
			'tag' => '<div class="sc">[qt_google_map address="'. __( 'Enter address here', 'tcd-genesis' ) . '"]</div>'
		),
		'design_header' => array(
			'display' => __( 'Slogan', 'tcd-genesis' ),
			'tag' => '<div class="design_header inview">' . "\n" . '<div class="title_area">' . "\n" . '<h2 class="large_headline"><span>HEADLINE</span></h2>' . "\n" . '<p class="sub_title colored"><span>' . __('Subheading', 'tcd-genesis') . '</span></p>' . "\n" . '</div>' . "\n" . '<div class="desc">' . "\n\n" . __('This description will be displayed right next to headline.', 'tcd-genesis') . "\n\n" . '</div>' . "\n" . '</div>'
		),
		'design_arrow_link' => array(
			'display' => __( 'Arrow button', 'tcd-genesis' ),
			'tag' => '<div class="design_arrow_button">' . "\n" . '<a href="#"><span class="label">' . __('Link text', 'tcd-genesis') . '</span><span class="arrow_button"></span></a>' . "\n" . '</div>'
		),
		'curtain_animation_image' => array(
			'display' => __( 'Curtain animation', 'tcd-genesis' ),
			'tag' => '<div class="shutter_image type2 inview col2">' . "\n" . '<div class="item">' . sprintf( __( '<img src="%s/img/shutter_image.gif" title="Put image here">', 'tcd-genesis' ), get_template_directory_uri() ) . '</div>' . "\n" . '<div class="item">' . sprintf( __( '<img src="%s/img/shutter_image.gif" title="Put image here">', 'tcd-genesis' ), get_template_directory_uri() ) . '</div>' . "\n" . '</div>'
		),
