...
/**
 * This is from https://github.com/tubalmartin/YUI-CSS-compressor-PHP-port
 *
 * Marged from
 * https://github.com/tubalmartin/YUI-CSS-compressor-PHP-port/blob/master/src/Minifier.php
 * https://github.com/tubalmartin/YUI-CSS-compressor-PHP-port/blob/master/src/Colors.php
 * https://github.com/tubalmartin/YUI-CSS-compressor-PHP-port/blob/master/src/Utils.php
 *
 * Customize:
 * Change namespace from tubalmartin\CssMin to tcd\acceleration.
 * Change class name from Minifier to CssMin.
 */
