...
<div class="custom_category_meta" style="margin:20px 0;">
 <h3 class="ccm_headline"><?php _e( 'Additional user data', 'tcd-genesis' ); ?></h3>
...
?>
  ...
  <h4 class="headline"><?php _e( 'Profile in blog page', 'tcd-genesis' ); ?></h4>
  <div class="input_field cf">
   <div class="standard_radio_button">
    ...
    <label for="show_author_yes"><?php _e('Display', 'tcd-genesis'); ?></label>
    <input id="show_author_no" type="radio" name="show_author" value="2" <?php checked( $show_author, '2' ); ?>>
    <label for="show_author_no"><?php _e('Hide', 'tcd-genesis'); ?></label>
   </div>
  </div><!-- END input_field -->

  <h4 class="headline"><?php _e( 'Instagram URL', 'tcd-genesis' ); ?></h4>
...
<?php
	...
	// 以下全ユーザー
?>
  <h4 class="headline"><?php _e( 'Profile image', 'tcd-genesis' ); ?></h4>
  <div class="input_field">
   <div class="theme_option_message2">
    <p><?php printf(__('Recommend image size. Width:%1$spx, Height:%2$spx.', 'tcd-genesis'), '300', '300'); ?></p>
   </div>
