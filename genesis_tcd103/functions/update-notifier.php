...
define(
	...
	'http://design-plus1.com/notifier_genesis.xml'
);
...
function tcd_update_notifier_admin_menu() {
	...
	if ( version_compare( $theme_data['Version'], $xml->latest, '<' ) ) {
		add_dashboard_page(
			...
			__( 'Theme Update', 'tcd-genesis' ) . '<span class="update-plugins count-1"><span class="update-count">1</span></span>',
			'administrator',
			'design-plus-updates',
...
function tcd_update_notifier_content() {
	...
	<div class="wrap">
		...
		<h2>
			...
			<?php esc_html_e( 'Theme Update Information', 'tcd-genesis' ); ?>
		</h2>
			...
			<p>
				<strong>
					<?php
						printf(
							...
							esc_html__( 'The latest version of %s is released.', 'tcd-genesis' ),
				...
				<?php
					printf(
						...
						esc_html__( 'Current version is %1$s. You can update to the latest version, %2$s.', 'tcd-genesis' ),
		...
		<div class="tcd-update-instructions wp-clearfix">
			<h3><?php esc_html_e( 'Note: Please be sure to backup your theme before you update to the latest version.', 'tcd-genesis' ); ?></h3>
			<p style="font-size:16px;">
				【 <a href="https://tcd.style/login" rel="noopener" target="_blank"><?php esc_html_e( 'Download the latest theme from My Page', 'tcd-genesis' ); ?></a> 】<br>
			...
			<div class="tcd-update-info">
				<h3><?php esc_html_e( 'Changelog', 'tcd-genesis' ); ?></h3>
